...
const LEGAL_STEPS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        from: 'ai',
        text: '🛡️ AILEGAL Node activated. Securely processing document...',
        typing: true,
        ms: 1000,
      },
      {
        from: 'ai',
        text: '✅ Upload successful. Initializing deep clause scanning...',
        card: 'upload',
        ms: 1200,
      },
    ],
  },
  {
    ...
    steps: [
      {
        from: 'ai',
        text: '🧠 Analyzing 146 clauses across 12 sections...',
        typing: true,
        ms: 1100,
      },
      {
        from: 'ai',
        text: '📡 Cross-referencing current jurisdictional Case Laws...',
        typing: true,
        ms: 1000,
      },
      {
        from: 'ai',
        text: '🔍 Detecting hidden indemnity mismatches...',
        card: 'analysis',
        ms: 1300,
      },
    ],
  },
  {
    ...
    steps: [
      {
        from: 'ai',
        text: '⚠️ Critical clause mismatch detected in Section 4.2.',
        typing: true,
        ms: 900,
      },
      {
        from: 'ai',
        text: '✅ Mutual liability confirmed for intellectual property.',
        typing: true,
        ms: 800,
      },
  ...
  },
  {
    ...
    steps: [
      {
        from: 'ai',
        text: '💡 Recommendation: Request a mutual cap on liability to align with market standards.',
        typing: true,
        ms: 1200,
      },
      {
        from: 'ai',
        text: '✅ Document score: 84/100. Follow insights to reach 100%',
        card: 'insight',
        ms: 300,
      },
    ],
...
const ActionCard = ({ type, isDarkMode }) => {
    ...
    return (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, width: '100%' }}>
          ...
          <div
            style={{ flex: 1, height: 4, borderRadius: 999, background: 'rgba(255,255,255,0.05)' }}
          >
            <div
              style={{
                width: '100%',
        ...
        >
          CONTRACT_004.PDF —{' '}
          {t('ailegalNodeActivated').includes('processing')
            ? 'SECURING...'
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to bottom, transparent, rgba(99,102,241,0.1), transparent)',
  ...
  if (type === 'results')
    return (
      <div
        style={{ marginTop: 10, width: '100%', display: 'flex', flexDirection: 'column', gap: 8 }}
      >
        <div
          style={{
            display: 'flex',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: '0.72rem', color: '#f43f5e', fontWeight: 600 }}>
              {t('sectionLiabilityCap')}
            </span>
          </div>
          <span style={{ fontSize: '0.6rem', fontWeight: 900, color: '#f43f5e', opacity: 0.6 }}>
            {t('highRisk')}
          </span>
        </div>
        <div
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: '0.72rem', color: '#10b981', fontWeight: 600 }}>
              {t('terminationRightsMapped')}
            </span>
          </div>
          <span style={{ fontSize: '0.6rem', fontWeight: 900, color: '#10b981', opacity: 0.6 }}>
            {t('safe')}
          </span>
        </div>
      </div>
    ...
    return (
      ...
      >
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '0.65rem', color: 'rgba(16,185,129,0.8)', marginTop: 2 }}>
            {t('readyForNegotiation')}
          </div>
        </div>
      </div>
    );
        ...
        <div
          ...
          style={{
            ...
            boxShadow: isDarkMode
              ...
              : '0 40px 80px -15px rgba(79,70,229,0.30), inset 0 2px 4px rgba(255,255,255,0.85)',
        ...
        >
          ...
          <div
            style={{
              ...
              zIndex: 3,
              pointerEvents: 'none',
              boxShadow: isDarkMode ? 'none' : 'inset 0 1px 3px rgba(255,255,255,0.8)',
            }}
          />
                ...
                {messages.length === 0 && (
                  ...
                  >
                    ...
                    <span style={{ fontSize: '0.8rem', fontWeight: 700, letterSpacing: '0.05em' }}>
                      {t('booting')} {feat.label.toUpperCase()}...
                    </span>
                  </div>
                )}
                {messages.map(msg => (
