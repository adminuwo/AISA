...
export const AiHearingClerkModal = ({ visible, onClose, hearing }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-white dark:bg-[#1a2540] w-full sm:w-[520px] sm:rounded-3xl rounded-t-3xl p-6 shadow-2xl border border-slate-200 dark:border-zinc-800/80"
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-black text-slate-900 dark:text-white uppercase tracking-wide">
                AI Hearing Clerk Dossier
              </h3>
              <p className="text-[10px] text-slate-400 font-bold uppercase mt-0.5">
                Courtroom Briefing & Preparation
              </p>
            </div>
          </div>
          <button
        ...
        <div className="mb-5">
          ...
          <h4 className="text-lg font-black text-slate-850 dark:text-white leading-snug">
            {hearing.stage || 'General Appearance'}
          </h4>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
          ...
          <div className="bg-slate-50 dark:bg-black/10 border border-slate-100 dark:border-zinc-800/40 p-2.5 rounded-xl">
            ...
            <span className="text-xs font-bold text-slate-700 dark:text-white block truncate">
              {hearing.judge || 'Justice Dixit'}
            </span>
            <span className="text-[10px] font-bold text-slate-400 block mt-0.5">
              {hearing.courtRoom || 'Courtroom 3'}
            </span>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-black/10 border border-slate-100 dark:border-zinc-800/40 p-2.5 rounded-xl flex flex-col justify-between">
            ...
            <span
              className={`inline-block px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider border self-start ${statusStyle}`}
            >
              {hearing.status}
            </span>
          </div>
        ...
        <div className="mb-6">
          <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1">
            AI Briefing Clerk Preparations
          </span>
          <div className="p-4 bg-slate-50 dark:bg-black/20 border border-slate-200/50 dark:border-zinc-800/80 rounded-2xl max-h-[160px] overflow-y-auto leading-relaxed">
            <p className="text-xs text-slate-650 dark:text-slate-350 font-semibold">
              {hearing.clerkNotes ||
                'AI has analyzed this hearing and confirmed preparation details. Refer to corresponding docket entries for evidentiary compliance checks.'}
            </p>
          </div>
        </div>
