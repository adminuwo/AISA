...
const categoryColors = {
  ...
  Other: {
    ...
    text: 'text-gray-650 dark:text-gray-400',
...
export const TimelineDetailsModal = ({ visible, onClose, event }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative bg-white dark:bg-[#1a2540] w-full sm:w-[500px] sm:rounded-3xl rounded-t-3xl p-6 shadow-2xl border border-slate-200 dark:border-zinc-800/80"
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          ...
          <div className="bg-slate-50 dark:bg-black/10 border border-slate-100 dark:border-zinc-800/40 p-2.5 rounded-xl">
            ...
            <span
              className={`inline-block px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider border ${catStyle.bg} ${catStyle.text} ${catStyle.border}`}
            >
              {event.category}
            </span>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-black/10 border border-slate-100 dark:border-zinc-800/40 p-2.5 rounded-xl">
            ...
            <span
              className={`inline-block px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider border ${prioStyle}`}
            >
              {event.priority}
            </span>
          </div>
          ...
          <div className="bg-slate-50 dark:bg-black/10 border border-slate-100 dark:border-zinc-800/40 p-2.5 rounded-xl text-center">
            ...
            <span
              className={`inline-block px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider border ${confStyle}`}
            >
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 text-xs text-slate-700 dark:text-white font-bold">
              {event.isAiGenerated ? (
                ...
                <Scale size={13} className="text-slate-405" />
              )}
