...
export const DRAFT_TEMPLATES = {
  ...
  'FIR Draft': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Name(s) of accused person(s)',
      },
      {
        key: 'accusedAddress',
        ...
        type: 'text',
        required: false,
        placeholder: 'Known address of accused',
      },
      ...
      {
        key: 'ipcSections',
        label: 'IPC Sections Applicable',
        type: 'text',
        required: false,
        placeholder: 'e.g., IPC 420, 406, 120B',
      },
      {
        key: 'incidentFacts',
        label: 'Facts of the Incident',
        type: 'textarea',
        required: true,
        placeholder: 'Describe the incident in detail — who, what, when, where, how...',
      },
      {
        ...
        type: 'textarea',
        required: false,
        placeholder: 'CCTV footage, messages, documents, witnesses...',
      },
      {
        key: 'reliefSought',
        label: 'Relief Sought',
        type: 'textarea',
        required: true,
        placeholder: 'Registration of FIR, arrest of accused, investigation...',
      },
      {
        key: 'advocateName',
        label: 'Advocate Name',
        type: 'text',
        required: false,
        placeholder: 'Name of the Advocate (if any)',
      },
    ],
    systemPrompt:
      'You are an expert criminal law advocate. Draft a formal FIR (First Information Report) complaint in professional legal format suitable for submission to the Police Station. Follow the format: Complainant details, Accused details, Facts, Offences committed, Evidence, Prayer for Registration of FIR.',
  },
  ...
  'Bail Application': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Sessions Court / High Court',
      },
      {
        key: 'judgeName',
        label: 'Judge Name (if known)',
        type: 'text',
        required: false,
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Details of custody, jail, remand orders...',
      },
      {
        key: 'groundsForBail',
        ...
        required: true,
        placeholder:
          'Elaborate grounds — no criminal record, cooperative, flight risk minimal, family dependent...',
      },
      {
        key: 'surety',
        ...
        type: 'text',
        required: false,
        placeholder: 'Name and address of surety person',
      },
      {
        key: 'advocateName',
        label: 'Advocate Name',
  ...
  'Anticipatory Bail': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Concerned Police Station',
      },
      {
        key: 'ipcSections',
        ...
        type: 'text',
        required: true,
        placeholder: 'IPC Sections likely to be invoked',
      },
      {
        key: 'fearOfArrest',
        label: 'Reason for Fear of Arrest',
        type: 'textarea',
        required: true,
        placeholder: 'Why applicant apprehends arrest...',
      },
      {
        key: 'groundsForAnticipatoryBail',
        label: 'Grounds for Anticipatory Bail',
        type: 'textarea',
        required: true,
        placeholder: 'False implication, no criminal antecedents, cooperative...',
      },
      {
        key: 'previousComplaint',
        label: 'Previous Complaint/Case Details',
        type: 'textarea',
        required: false,
        placeholder: 'Any prior complaint or case details...',
      },
      {
        key: 'conditionsOffered',
        label: 'Conditions Offered',
        type: 'textarea',
        required: false,
        placeholder: 'Passport surrender, weekly reporting, not tampering evidence...',
      },
      {
        key: 'advocateName',
        label: 'Advocate Name',
    ...
    systemPrompt:
      'You are a senior criminal advocate. Draft a formal Anticipatory Bail Application under Section 438 CrPC for submission before the Sessions Court/High Court. Include: Applicant details, grounds of apprehension, absence of criminal antecedents, cooperative nature, prayer for pre-arrest bail with conditions.',
  },
  ...
  'Criminal Complaint': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Judicial Magistrate Court',
      },
      {
        key: 'accusedName',
      ...
      { key: 'offenceDate', label: 'Date of Offence', type: 'date', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Location of the offence',
      },
      {
        key: 'ipcSections',
        label: 'IPC/Penal Sections',
        type: 'text',
        required: true,
        placeholder: 'IPC 420, 406, 500 etc.',
      },
      {
        key: 'facts',
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Detailed narration of the offence...',
      },
      {
        key: 'evidence',
        ...
        type: 'textarea',
        required: false,
        placeholder: 'List of evidence available...',
      },
      {
        key: 'reliefSought',
        label: 'Relief Sought',
        type: 'textarea',
        required: true,
        placeholder: 'Cognizance of offence, summoning accused, trial...',
      },
      {
        key: 'advocateName',
        label: 'Advocate Name',
    ...
    systemPrompt:
      'Draft a formal criminal complaint for submission before the Judicial Magistrate under Section 200 CrPC. Include complainant details, accused details, offence particulars, grounds, evidence, and prayer for cognizance and summoning of accused.',
  },
  ...
  'Police Complaint': {
    ...
    fields: [
      ...
      { key: 'incidentPlace', label: 'Incident Location', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. Cheating, Harassment, Theft...',
      },
      {
        key: 'facts',
        label: 'Complete Facts',
        type: 'textarea',
        required: true,
    ...
    systemPrompt:
      'Draft a formal police complaint letter addressed to the Station House Officer. Include complainant details, subject, facts, incident narration, witness information and request for appropriate police action including FIR registration and investigation.',
  },
  ...
  'Cyber Crime FIR': {
    ...
    fields: [
      ...
      {
        key: 'accusedProfile',
        label: 'Accused Profile/URL',
        type: 'text',
        required: false,
        placeholder: 'Profile URL, phone number, email of accused',
      },
      {
        key: 'incidentFacts',
        label: 'Detailed Incident Facts',
        type: 'textarea',
        required: true,
        placeholder: 'Step by step narration of how the crime occurred...',
      },
      {
        key: 'digitalEvidence',
        ...
        type: 'textarea',
        required: false,
        placeholder: 'Screenshots, transaction IDs, call logs, emails...',
      },
      { key: 'reliefSought', label: 'Relief Sought', type: 'textarea', required: true },
    ],
    systemPrompt:
      'Draft a formal Cyber Crime FIR/Complaint to be submitted to the Cyber Crime Cell under IT Act 2000 and relevant IPC sections. Include all digital evidence references, platform details, and prayer for blocking/freezing accounts and investigation.',
  },
  ...
  'Legal Notice': {
    ...
    fields: [
      ...
      {
        key: 'subject',
        label: 'Subject / Nature of Dispute',
        type: 'text',
        required: true,
        placeholder: 'e.g. Recovery of Dues, Breach of Contract',
      },
      {
        key: 'facts',
        label: 'Facts of the Dispute',
        type: 'textarea',
        required: true,
        placeholder: 'Chronological facts leading to this notice...',
      },
      {
        key: 'causeOfAction',
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Legal grounds, agreements breached, losses suffered...',
      },
      {
        key: 'amountDue',
        label: 'Amount Due (if applicable)',
        type: 'text',
        required: false,
        placeholder: '₹ Amount',
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Payment demanded, action required, time limit given...',
      },
      {
        key: 'timeLimit',
        label: 'Time Limit Given',
        type: 'text',
        required: true,
    ...
    systemPrompt:
      'Draft a formal legal notice under signature of advocate. Include sender/client particulars, receiver details, subject, chronological facts, cause of action, demand/relief, time limit for compliance, and consequence of non-compliance (legal proceedings). Use formal legal language.',
  },
  ...
  'Recovery Notice': {
    ...
    fields: [
      ...
      {
        key: 'transactionDate',
        label: 'Date of Transaction/Agreement',
        type: 'date',
        required: true,
      },
      ...
      {
        key: 'previousReminders',
        label: 'Previous Reminders Given',
        type: 'textarea',
        required: false,
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. 7 days from receipt of this notice',
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ],
    systemPrompt:
      'Draft a formal Recovery Notice demanding repayment of dues. Include creditor particulars, transaction history, amount breakdown (principal + interest), previous communication records, demand for payment within specified period, and warning of legal proceedings under Order 37 CPC and applicable laws.',
  },
  ...
  'Civil Suit': {
    ...
    fields: [
      ...
      { key: 'suitValuation', label: 'Suit Valuation (₹)', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. Breach of Contract, Recovery of Money',
      },
      { key: 'facts', label: 'Statement of Facts', type: 'textarea', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Sections, Acts, case laws relied upon...',
      },
      { key: 'reliefClaimed', label: 'Relief Claimed', type: 'textarea', required: true },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ],
    systemPrompt:
      'Draft a formal Civil Suit plaint under CPC Order 7. Include plaintiff and defendant details, court jurisdiction, valuation, cause of action, statement of facts, legal grounds (sections/acts), prayer for relief, and verification clause.',
  },
  ...
  'Injunction Petition': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Property / Activity to be restrained',
      },
      {
        key: 'urgency',
        label: 'Urgency / Prima Facie Case',
        type: 'textarea',
        required: true,
        placeholder: 'Why immediate injunction is needed...',
      },
      {
        key: 'irreparableHarm',
        label: 'Irreparable Harm if Not Granted',
        type: 'textarea',
        required: true,
      },
      {
        key: 'balanceOfConvenience',
    ...
    systemPrompt:
      'Draft a formal Injunction Petition under Order 39 CPC establishing prima facie case, balance of convenience, irreparable harm. Include urgency, supporting facts, and prayer for temporary/permanent injunction with or without notice.',
  },
  ...
  'Property Dispute': {
    ...
    fields: [
      ...
      { key: 'courtName', label: 'Court Name', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Survey No., Address, Area, boundaries...',
      },
      {
        key: 'titleDocuments',
        ...
        type: 'text',
        required: false,
        placeholder: 'Sale deed, registry, mutation...',
      },
      {
        key: 'disputeNature',
    ...
    systemPrompt:
      'Draft a formal property dispute suit/petition. Include property description, title documents, chain of ownership, nature of encroachment/dispute, facts, legal grounds under TPA/CPC, and prayer for declaration of title, possession, or injunction.',
  },
  ...
  'Compensation Claim': {
    ...
    fields: [
      ...
      {
        key: 'lossesIncurred',
        label: 'Losses / Damages Suffered',
        type: 'textarea',
        required: true,
        placeholder: 'Physical, financial, mental losses...',
      },
      {
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Sections, negligence, breach...',
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ],
    systemPrompt:
      'Draft a formal compensation claim petition. Include claimant details, incident description, legal basis for compensation (negligence/breach/strict liability), loss assessment, quantum of damages, and prayer for compensation with interest.',
  },
  ...
  'Divorce Petition': {
    ...
    fields: [
      ...
      { key: 'respondentName', label: 'Respondent (Spouse) Name', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Family Court, District...',
      },
      ...
      { key: 'separationDate', label: 'Date of Separation', type: 'date', required: false },
      {
        ...
        type: 'textarea',
        required: false,
        placeholder: 'Names, ages, custody preference...',
      },
      {
        key: 'groundsForDivorce',
      ...
      {
        key: 'factsOfDivorce',
        label: 'Facts Supporting Grounds',
        type: 'textarea',
        required: true,
        placeholder: 'Detailed facts establishing grounds for divorce...',
      },
      {
        key: 'previousProceedings',
        label: 'Previous Proceedings',
        type: 'textarea',
        required: false,
      },
      {
        key: 'matrimonialProperty',
        label: 'Matrimonial Property Details',
        type: 'textarea',
        required: false,
      },
      {
        key: 'maintenanceClaim',
        label: 'Maintenance/Alimony Claim',
        type: 'text',
        required: false,
      },
      { key: 'reliefSought', label: 'Relief Sought', type: 'textarea', required: true },
    ...
    systemPrompt:
      'Draft a formal Divorce Petition under Hindu Marriage Act 1955 / Special Marriage Act / applicable personal law. Include marriage details, grounds, supporting facts, children details, property division, maintenance, and prayer for dissolution of marriage.',
  },
  ...
  'Mutual Divorce': {
    ...
    fields: [
      {
        key: 'petitioner1Name',
        label: 'Petitioner 1 (Husband) Name',
        type: 'text',
        required: true,
      },
      ...
      {
        key: 'livingApartDuration',
        label: 'Living Apart Duration',
        type: 'text',
        required: true,
        placeholder: 'e.g. More than 1 year',
      },
      { key: 'childrenDetails', label: 'Children Details', type: 'textarea', required: false },
      {
        key: 'settledTerms',
        label: 'Terms Mutually Settled',
        type: 'textarea',
        required: true,
        placeholder: 'Custody, maintenance, alimony, property division...',
      },
      {
        key: 'alimonyAmount',
        label: 'Alimony / Settlement Amount (₹)',
        type: 'text',
        required: false,
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ...
    systemPrompt:
      'Draft a Mutual Consent Divorce Petition under Section 13B Hindu Marriage Act. Include joint petitioner details, marriage details, separation period (1 year+), mutually agreed terms (custody, alimony, property), and joint prayer for dissolution.',
  },
  ...
  'Child Custody': {
    ...
    fields: [
      ...
      {
        key: 'childCurrentStatus',
        label: "Child's Current Status",
        type: 'textarea',
        required: true,
        placeholder: 'With whom child is currently living, school, wellbeing...',
      },
      {
        key: 'relationshipToChild',
        label: "Petitioner's Relationship to Child",
        type: 'text',
        required: true,
      ...
      {
        key: 'groundsForCustody',
        label: 'Grounds for Custody',
        type: 'textarea',
        required: true,
        placeholder: "Why petitioner is better suited for child's welfare...",
      },
      {
        key: 'childWelfareDetails',
        label: 'Child Welfare Considerations',
        type: 'textarea',
        required: true,
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ...
    systemPrompt:
      "Draft a Child Custody Petition under Guardian and Wards Act 1890 / Hindu Minority and Guardianship Act. Emphasize child's best interest as paramount consideration. Include petitioner qualifications for custody, living conditions, financial stability, emotional attachment, and prayer for custody.",
  },
  ...
  'Maintenance Petition': {
    ...
    fields: [
      ...
      { key: 'courtName', label: 'Court Name', type: 'text', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: ['Wife', 'Children', 'Parents', 'Divorced Wife', 'Other'],
      },
      { key: 'marriageDate', label: 'Date of Marriage', type: 'date', required: false },
      { key: 'separationDate', label: 'Date of Separation', type: 'date', required: false },
      {
        key: 'petitionerIncome',
        label: "Petitioner's Income/Resources",
        type: 'text',
        required: true,
        placeholder: 'Monthly income or "Nil"',
      },
      {
        key: 'respondentIncome',
        label: "Respondent's Estimated Income",
        type: 'text',
        required: true,
      },
      {
        key: 'maintenanceRequired',
        label: 'Monthly Maintenance Required (₹)',
        type: 'text',
        required: true,
      },
      {
        key: 'groundsForMaintenance',
    ...
    systemPrompt:
      "Draft a Maintenance Petition under Section 125 CrPC / Section 24 HMA / applicable law. Include petitioner's needs, respondent's capacity, marriage details, desertion/neglect, and prayer for monthly maintenance including interim maintenance.",
  },
  ...
  'Domestic Violence Case': {
    ...
    fields: [
      ...
      {
        key: 'relationshipToRespondent',
        label: 'Relationship to Respondent',
        type: 'select',
        required: true,
        options: ['Spouse', 'In-Laws', 'Live-in Partner', 'Family Member', 'Other'],
      },
      {
        key: 'dvActsCommitted',
        label: 'Acts of Domestic Violence',
        type: 'textarea',
        required: true,
        placeholder:
          'Physical abuse, emotional abuse, economic abuse, sexual abuse — describe incidents with dates',
      },
      {
        key: 'medicalReports',
        label: 'Medical Reports / Injuries',
        type: 'textarea',
        required: false,
      },
      ...
      {
        key: 'reliefSought',
        label: 'Relief Under DV Act',
        type: 'textarea',
        required: true,
        placeholder: 'Protection Order, Residence Order, Monetary Relief, Compensation...',
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ],
    systemPrompt:
      'Draft a formal complaint/application under Protection of Women from Domestic Violence Act 2005. Include aggrieved person details, acts of domestic violence (physical, mental, economic, sexual), shared household, prayer for Protection Order, Residence Order, monetary relief, and compensation.',
  },
  ...
  'Adoption Petition': {
    ...
    fields: [
      ...
      {
        key: 'adoptiveParentsAddress',
        label: 'Adoptive Parents Address',
        type: 'textarea',
        required: true,
      },
      { key: 'courtName', label: 'Court Name', type: 'text', required: true },
      ...
      {
        key: 'naturalParentsDetails',
        label: 'Natural/Biological Parents Details',
        type: 'textarea',
        required: false,
      },
      ...
      {
        key: 'financialStatus',
        label: 'Financial Status of Adoptive Parents',
        type: 'text',
        required: true,
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ...
    systemPrompt:
      'Draft a formal Adoption Petition under Hindu Adoption and Maintenance Act / JJ Act. Include adoptive parent qualifications, child background, consent details, home study report reference, and prayer for adoption order.',
  },
  ...
  'Sale Agreement': {
    ...
    fields: [
      ...
      { key: 'buyerAddress', label: 'Buyer Address', type: 'textarea', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Survey No., Plot No., Address, dimensions, boundaries...',
      },
      ...
      { key: 'balanceAmount', label: 'Balance Amount (₹)', type: 'text', required: true },
      {
        ...
        label: 'Proposed Registration Date',
        type: 'date',
        required: true,
      },
      { key: 'possessionDate', label: 'Possession Date', type: 'date', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Free from encumbrance / Loan details',
      },
      { key: 'specialConditions', label: 'Special Conditions', type: 'textarea', required: false },
    ],
    systemPrompt:
      'Draft a formal Agreement for Sale of immovable property. Include seller/buyer details, property description (with boundaries), consideration amount, advance paid, payment schedule, encumbrance status, possession date, registration obligations, and penalty for breach.',
  },
  ...
  'Rent Agreement': {
    ...
    systemPrompt:
      'Draft a formal Rental Agreement / Leave and License Agreement. Include landlord/tenant details, property description, rent amount, security deposit, duration, lock-in period, notice period, permitted use, maintenance obligations, utility payments, termination conditions, and dispute resolution.',
  },
  ...
  'Lease Agreement': {
    ...
    fields: [
      ...
      { key: 'propertyDetails', label: 'Property Details', type: 'textarea', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. 5 years from [date]',
      },
    ...
    systemPrompt:
      'Draft a formal Deed of Lease for immovable property. Include lessor/lessee details, property description, lease period, rent, security deposit, permitted use, maintenance, renewal options, sub-letting restrictions, termination conditions, and stamp duty compliance.',
  },
  ...
  'Tenant Eviction Notice': {
    ...
    fields: [
      ...
      {
        key: 'legalWarning',
        label: 'Legal Action if Not Vacated',
        type: 'textarea',
        required: false,
        placeholder: 'Eviction suit, recovery proceedings...',
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: false },
    ],
    systemPrompt:
      'Draft a formal Eviction/Vacate Notice under Rent Control Act / Transfer of Property Act. Include landlord/tenant details, property description, grounds for eviction, arrears, deadline to vacate, and warning of legal proceedings (eviction suit).',
  },
  ...
  'Registry Verification': {
    ...
    fields: [
      ...
      {
        key: 'purposeOfVerification',
        label: 'Purpose of Verification',
        type: 'text',
        required: true,
        placeholder: 'Purchase, Mortgage, Legal Due Diligence...',
      },
      {
    ...
    systemPrompt:
      'Draft a formal application for property title/registry verification. Include property details, survey number, encumbrance certificate request, chain of title verification request, and certified copies of registered documents.',
  },
  ...
  'Property Transfer': {
    ...
    fields: [
      ...
      { key: 'transfereeName', label: 'Transferee Name', type: 'text', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: ['Sale', 'Gift', 'Inheritance', 'Exchange', 'Partition', 'Will Execution'],
      },
      { key: 'propertyDetails', label: 'Property Details', type: 'textarea', required: true },
      { key: 'propertyValue', label: 'Property Market Value (₹)', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: false,
        placeholder: 'Amount paid or "Love and Affection" for gift',
      },
    ...
    systemPrompt:
      'Draft a formal Property Transfer Deed / Conveyance Deed / Gift Deed under Transfer of Property Act. Include transferor/transferee details, property description, consideration, transfer conditions, possession delivery, and registration compliance.',
  },
  ...
  'NDA Draft': {
    ...
    fields: [
      ...
      { key: 'effectiveDate', label: 'Effective Date', type: 'date', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: ['Unilateral', 'Mutual/Bilateral'],
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Business discussion, partnership evaluation, due diligence...',
      },
      {
        key: 'confidentialInfoScope',
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. Laws of India, Delhi Courts',
      },
      { key: 'penaltyForBreach', label: 'Remedy for Breach', type: 'text', required: false },
    ],
    systemPrompt:
      'Draft a professional Non-Disclosure Agreement (NDA). Include parties, definition of confidential information, disclosure purpose, obligations, exceptions (public domain, prior knowledge, compelled disclosure), duration, injunctive relief remedy, governing law, and dispute resolution.',
  },
  ...
  'Contract Draft': {
    ...
    fields: [
      ...
      { key: 'party2Address', label: 'Party 2 Address', type: 'textarea', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Service Agreement, Purchase Agreement, SLA...',
      },
      ...
      { key: 'governingLaw', label: 'Governing Law & Jurisdiction', type: 'text', required: true },
      {
        ...
        options: [
          ...
          'Mediation',
          'Court Litigation',
          'Negotiation first then Arbitration',
        ],
      },
    ],
    systemPrompt:
      'Draft a comprehensive commercial contract/service agreement. Include parties, scope of services, deliverables, timelines, payment terms, IP ownership, representations and warranties, indemnification, limitation of liability, termination rights, governing law, and dispute resolution.',
  },
  ...
  'Employment Agreement': {
    ...
    systemPrompt:
      'Draft a comprehensive Employment Agreement. Include employer/employee details, role, CTC, benefits, working hours, probation, notice period, IP assignment, confidentiality, non-compete/non-solicitation, code of conduct, termination conditions, and dispute resolution under Indian labour laws.',
  },
  ...
  'Partnership Agreement': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Partner 1: ₹X, Partner 2: ₹Y...',
      },
      {
    ...
    systemPrompt:
      'Draft a formal Partnership Deed under Indian Partnership Act 1932. Include firm name, partners, business nature, capital, profit/loss sharing, management powers, banking, admission/retirement of partners, dissolution clause, and dispute resolution.',
  },
  ...
  'Vendor Agreement': {
    ...
    fields: [
      ...
      { key: 'contractValue', label: 'Contract Value (₹)', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Lead times, locations, frequency...',
      },
      {
        key: 'paymentTerms',
        label: 'Payment Terms',
    ...
    systemPrompt:
      'Draft a Vendor/Supplier Agreement covering supply terms, delivery obligations, quality specifications, price, payment terms, penalty for delays, force majeure, IP ownership of custom work, termination rights, indemnification, and dispute resolution.',
  },
  ...
  'Startup Compliance': {
    ...
    fields: [
      ...
      {
        key: 'directors',
        label: 'Directors / Designated Partners',
        type: 'textarea',
        required: true,
      },
      {
      ...
      {
        key: 'startupIndiaCriteria',
        label: 'Startup India Registration Criteria',
        type: 'textarea',
        required: false,
      },
      {
        key: 'complianceScope',
        label: 'Compliance Scope Required',
        type: 'textarea',
        required: true,
      },
    ],
    systemPrompt:
      'Draft a Startup Compliance Document covering incorporation structure, founders agreement, IP assignment, ESOP policy, Startup India registration eligibility, GST registration, statutory compliance checklist (ROC filings, annual returns), and recommended legal framework.',
  },
  ...
  'Loan Dispute': {
    ...
    fields: [
      ...
      {
        key: 'previousCorrespondence',
        label: 'Previous Communication with Bank',
        type: 'textarea',
        required: false,
      },
      { key: 'reliefSought', label: 'Relief Sought', type: 'textarea', required: true },
    ...
    systemPrompt:
      'Draft a formal Loan Dispute Petition/Complaint to DRT/Banking Ombudsman/Civil Court. Include loan details, nature of dispute, illegal charges/actions, RBI guidelines violated, prayer for stay of recovery proceedings, correction of records, and compensation.',
  },
  ...
  'Cheque Bounce Notice': {
    ...
    fields: [
      ...
      { key: 'dishonourDate', label: 'Date of Dishonour', type: 'date', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Insufficient funds, account closed, stop payment...',
      },
      {
        key: 'underlyingTransaction',
        label: 'Underlying Transaction',
        type: 'textarea',
        required: true,
        placeholder: 'Purpose for which cheque was given...',
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ],
    systemPrompt:
      'Draft a formal legal notice under Section 138 Negotiable Instruments Act 1881. This is mandatory 15-day demand notice before filing complaint. Include payee/drawer details, cheque particulars, dishonour details, legal demand within 15 days of receipt, and warning of criminal prosecution.',
  },
  ...
  'Banking Fraud Complaint': {
    ...
    systemPrompt:
      "Draft a Banking Fraud complaint to be filed with Police Cyber Cell, Banking Ombudsman, and RBI. Include fraud details, transaction references, bank's failure to comply with RBI circular on liability in unauthorized transactions, and demand for refund with compensation.",
  },
  ...
  'EMI Settlement': {
    ...
    fields: [
      ...
      {
        key: 'settlementTerms',
        label: 'Proposed Settlement Terms',
        type: 'textarea',
        required: true,
      },
    ...
    systemPrompt:
      'Draft a formal One-Time Settlement (OTS) / Loan Restructuring application to the bank. Include borrower hardship, outstanding dues, settlement offer with justification, payment plan, and request for NOC/closure letter upon settlement.',
  },
  ...
  'Debt Recovery': {
    ...
    systemPrompt:
      'Draft a Debt Recovery application/suit. Include creditor/debtor details, debt origin, principal + interest calculation, previous demands, legal basis (Order 37 CPC / DRT Act / IBC), and prayer for recovery decree with interest and costs.',
  },
  ...
  'Financial Agreement': {
    ...
    fields: [
      ...
      { key: 'penaltyForDefault', label: 'Penalty for Default', type: 'text', required: false },
      {
        ...
        label: 'Guarantor Details (if any)',
        type: 'text',
        required: false,
      },
    ...
    systemPrompt:
      'Draft a formal Financial/Loan Agreement. Include lender/borrower details, loan amount, interest rate (reducing balance method), repayment schedule, security/collateral, guarantor obligations, default consequences, prepayment terms, and dispute resolution.',
  },
  ...
  'Employee Complaint': {
    ...
    fields: [
      ...
      {
        key: 'previousComplaints',
        label: 'Previous Internal Complaints',
        type: 'textarea',
        required: false,
      },
      { key: 'reliefSought', label: 'Relief Sought', type: 'textarea', required: true },
      {
        key: 'labourAuthority',
        label: 'Labour Authority',
        type: 'text',
        required: true,
        placeholder: 'Labour Commissioner / Industrial Tribunal / High Court',
      },
    ],
    systemPrompt:
      'Draft a formal employee complaint to Labour Commissioner / Industrial Tribunal under Industrial Disputes Act / Payment of Wages Act / Factories Act. Include employment details, nature of grievance, facts, applicable labour law violations, and prayer for relief.',
  },
  ...
  'Salary Recovery': {
    ...
    fields: [
      ...
      {
        key: 'duePeriod',
        label: 'Period for Which Salary is Due',
        type: 'text',
        required: true,
        placeholder: 'e.g. March to June 2024',
      },
      { key: 'lastSalaryReceived', label: 'Last Salary Received', type: 'text', required: false },
      {
        key: 'deductionDetails',
        label: 'Wrongful Deductions (if any)',
        type: 'textarea',
        required: false,
      },
      {
        key: 'employerResponse',
        label: "Employer's Response (if any)",
        type: 'textarea',
        required: false,
      },
    ...
    systemPrompt:
      'Draft a salary recovery claim under Payment of Wages Act / Industrial Disputes Act. Include employment particulars, salary breakdown, period of non-payment, employer default, and prayer for payment of arrears with 15% interest and compensation under Section 15 Payment of Wages Act.',
  },
  ...
  'Wrongful Termination': {
    ...
    fields: [
      ...
      {
        key: 'terminationBasis',
        label: 'Stated Reason for Termination',
        type: 'textarea',
        required: true,
      },
      {
        key: 'groundsForChallenge',
        label: 'Grounds for Challenging Termination',
        type: 'textarea',
        required: true,
      },
      {
        key: 'procedureViolated',
        label: 'Procedure Violated',
        type: 'textarea',
        required: true,
        placeholder: 'Show Cause Notice not given, natural justice violation...',
      },
      {
        key: 'settlementOffered',
        label: 'Settlement Offered by Employer',
        type: 'text',
        required: false,
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Reinstatement, back wages, compensation...',
      },
    ],
    systemPrompt:
      'Draft an Industrial Dispute complaint for wrongful/illegal termination under Section 2A Industrial Disputes Act. Challenge retrenchment without retrenchment compensation, violation of natural justice, discriminatory termination, and pray for reinstatement with continuity of service and full back wages.',
  },
  ...
  'Workplace Harassment': {
    ...
    fields: [
      ...
      {
        key: 'harassmentDates',
        label: 'Dates of Harassment Incidents',
        type: 'text',
        required: true,
      },
      ...
      {
        key: 'icComplaintFiled',
        label: 'Internal Committee Complaint Filed',
        type: 'select',
        required: false,
    ...
    systemPrompt:
      'Draft a workplace harassment complaint under POSH Act 2013 / Industrial Disputes Act / IPC provisions. Include incidents, dates, pattern of harassment, witnesses, impact on work, complaint to Internal Committee, and prayer for inquiry, disciplinary action, and compensation.',
  },
  ...
  'PF Dispute': {
    ...
    fields: [
      ...
      { key: 'complaintFacts', label: 'Facts of the Dispute', type: 'textarea', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Regional PF Office address',
      },
    ],
    systemPrompt:
      "Draft a complaint/grievance to EPFO Regional Office regarding PF non-compliance under Employees Provident Fund and Miscellaneous Provisions Act 1952. Include employment details, PF violation, employer's default, and prayer for recovery + penalty against employer.",
  },
  ...
  'Labour Notice': {
    ...
    systemPrompt:
      'Draft a formal Labour Law Notice to employer citing violations of Payment of Wages Act, Factories Act, Minimum Wages Act, Shops and Establishments Act, or Industrial Disputes Act. Demand compliance within specified period, warning of complaint to Labour Commissioner and legal proceedings.',
  },
  ...
  'Consumer Complaint': {
    ...
    fields: [
      ...
      {
        key: 'consumerForumLevel',
        label: 'Forum Level',
        type: 'select',
        required: true,
        options: [
          'District Commission (up to ₹50L)',
          'State Commission (₹50L-₹2Cr)',
          'National Commission (above ₹2Cr)',
        ],
      },
      ...
      },
      {
        ...
        label: 'Total Compensation Claimed (₹)',
        type: 'text',
        required: true,
      },
    ...
    systemPrompt:
      'Draft a formal Consumer Complaint under Consumer Protection Act 2019. Include complainant/opposite party details, purchase details, nature of deficiency/unfair trade practice, facts, previous complaints, and prayer for refund + compensation + litigation costs under Section 35 CPA.',
  },
  ...
  'Refund Notice': {
    ...
    fields: [
      ...
      {
        key: 'previousRefundRequests',
        label: 'Previous Refund Requests',
        type: 'textarea',
        required: false,
      },
    ...
    systemPrompt:
      'Draft a formal Refund Notice under Consumer Protection Act 2019. Include purchase details, defect/deficiency facts, refund demand, previous requests ignored, time limit for compliance, and warning of consumer forum complaint with compensation claim.',
  },
  ...
  'Product Defect Case': {
    ...
    systemPrompt:
      'Draft a Product Liability complaint under Consumer Protection Act 2019 Chapter VI. Include product details, defect description, injury/loss caused, manufacturer strict liability, and prayer for refund/replacement + compensation for injury, mental agony, litigation costs.',
  },
  ...
  'Online Shopping Fraud': {
    ...
    systemPrompt:
      "Draft a Consumer Complaint against e-commerce platform under Consumer Protection (E-Commerce) Rules 2020 and CPA 2019. Include order details, fraud/deficiency nature, platform's failure, and prayer for refund + e-commerce rule violation penalty + compensation.",
  },
  ...
  'Service Deficiency Complaint': {
    ...
    fields: [
      ...
      { key: 'serviceName', label: 'Service Provider Name', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Hospital, Builder, Telecom, Insurance, Education...',
      },
      { key: 'serviceDate', label: 'Date of Service', type: 'date', required: true },
      { key: 'amountPaid', label: 'Amount Paid (₹)', type: 'text', required: true },
      {
        key: 'deficiencyFacts',
        label: 'Nature of Service Deficiency',
        type: 'textarea',
        required: true,
      },
      { key: 'losses', label: 'Loss / Harm Suffered', type: 'textarea', required: true },
      {
        ...
        label: "Service Provider's Response",
        type: 'textarea',
        required: false,
      },
      {
    ...
    systemPrompt:
      'Draft a Consumer Complaint for service deficiency under CPA 2019 Section 2(11). Include service details, contracted vs delivered service gap, deficiency facts, losses, and prayer for refund + compensation for mental agony + litigation costs.',
  },
  ...
  'Social Media Harassment': {
    ...
    fields: [
      ...
      },
      {
        ...
        type: 'text',
        required: false,
        placeholder: 'IT Act 66A, 67; IPC 354D, 507...',
      },
      { key: 'reliefSought', label: 'Relief Sought', type: 'textarea', required: true },
    ],
    systemPrompt:
      'Draft a cyber crime complaint for social media harassment under IT Act 2000 Section 66C, 67 and IPC 354D, 509, 507. Include platform details, harassment type, digital evidence, NCPCR/cybercrime portal reference, and prayer for account takedown, FIR registration, and compensation.',
  },
  ...
  'Online Scam Complaint': {
    ...
    systemPrompt:
      'Draft a cyber crime FIR/complaint for online fraud under IT Act 2000 Section 66C, 66D and IPC 420, 419. Include cybercrime helpline (1930) filing reference, transaction details, modus operandi, and prayer for FIR, account freeze, and recovery of lost amount.',
  },
  ...
  'Data Privacy Complaint': {
    ...
    fields: [
      ...
      { key: 'dataBreachDate', label: 'Date of Breach / Discovery', type: 'date', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Name, Aadhaar, financial data, health data...',
      },
      {
        key: 'howDiscovered',
        label: 'How Breach Was Discovered',
        type: 'textarea',
        required: true,
      },
    ...
    systemPrompt:
      "Draft a Data Privacy Violation complaint under IT Act 2000 Section 43A, IT (Reasonable Security Practices) Rules 2011 and pending DPDP Act 2023. Include data breach details, company's failure to protect, harm suffered, and prayer for compensation and injunction to secure data.",
  },
  ...
  'Hacking Complaint': {
    ...
    fields: [
      ...
      {
        key: 'dataStolen',
        label: 'Data / Files Stolen/Damaged',
        type: 'textarea',
        required: false,
      },
    ...
    systemPrompt:
      'Draft a hacking complaint under IT Act 2000 Section 43, 66, 66B and IPC 379. Include system access details, unauthorized intrusion facts, data stolen, financial loss, and prayer for FIR, cyber forensic investigation, and compensation.',
  },
  ...
  'Fake Profile Complaint': {
    ...
    fields: [
      ...
      {
        key: 'platform',
        label: 'Platform Where Fake Profile Exists',
        type: 'text',
        required: true,
      },
      { key: 'fakeProfileURL', label: 'Fake Profile URL / ID', type: 'text', required: false },
      {
        ...
        label: 'When Profile Was Created / Discovered',
        type: 'date',
        required: false,
      },
      {
        key: 'impersonationFacts',
        label: 'How Impersonation Occurred',
        type: 'textarea',
        required: true,
      },
      { key: 'harmCaused', label: 'Harm / Damage Caused', type: 'textarea', required: true },
      {
        key: 'evidenceScreenshots',
    ...
    systemPrompt:
      'Draft a complaint for identity theft/impersonation under IT Act 2000 Section 66C and IPC 419, 468. Include fake profile evidence, harm to reputation, financial damage, and prayer for FIR, profile takedown order, and compensation.',
  },
  ...
  'Cyber Defamation': {
    ...
    fields: [
      ...
      {
        key: 'defamatoryContent',
        label: 'Nature of Defamatory Content',
        type: 'textarea',
        required: true,
      },
      ...
      {
        key: 'reputationDamage',
        label: 'Reputation / Business Damage',
        type: 'textarea',
        required: true,
      },
      {
        key: 'evidenceLinks',
        label: 'URLs / Screenshot Evidence',
        type: 'textarea',
        required: false,
      },
      { key: 'reliefSought', label: 'Relief Sought', type: 'textarea', required: true },
    ...
    systemPrompt:
      'Draft a cyber defamation complaint under IPC 499, 500 and IT Act Section 66A (principles still apply). Include defamatory publication details, falsity of statements, damage to reputation, and prayer for FIR, content removal order, and compensation.',
  },
  ...
  'GST Notice Reply': {
    ...
    fields: [
      ...
      {
        key: 'groundsOfDemand',
        label: 'Grounds Stated in Notice',
        type: 'textarea',
        required: true,
      },
      {
        key: 'replyGrounds',
        label: 'Grounds of Reply / Defence',
        type: 'textarea',
        required: true,
        placeholder:
          'Input tax credit entitlement, classification correct, exports properly documented...',
      },
      {
        key: 'documentsEnclosed',
        label: 'Documents to be Enclosed',
        type: 'textarea',
        required: false,
      },
      { key: 'reliefSought', label: 'Relief Sought', type: 'textarea', required: true },
    ...
    systemPrompt:
      'Draft a comprehensive Reply to GST Show Cause Notice under CGST Act 2017. Include taxpayer details, GSTIN, notice reference, factual reply, legal grounds under relevant CGST sections, supporting evidence, and prayer for dropping/reducing the demand.',
  },
  ...
  'Income Tax Appeal': {
    ...
    systemPrompt:
      "Draft a formal Income Tax Appeal before CIT(A) under Section 246A of Income Tax Act 1961. Include grounds of appeal, legal arguments against additions/disallowances, case laws supporting appellant's position, and prayer for deletion/reduction of demand.",
  },
  ...
  'Tax Dispute': {
    ...
    fields: [
      ...
      { key: 'pan_gstin', label: 'PAN / GSTIN', type: 'text', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: ['Income Tax', 'GST', 'TDS', 'Corporate Tax', 'Customs', 'State Tax'],
      },
    ...
    systemPrompt:
      'Draft a Tax Dispute Petition / Rectification Application / Writ Petition against arbitrary tax assessment. Include taxpayer details, assessment facts, legal errors in assessment, applicable case laws, and prayer for reassessment or quashing of demand.',
  },
  ...
  'GST Registration Draft': {
    ...
    fields: [
      ...
      { key: 'stateJurisdiction', label: 'State / Jurisdiction', type: 'text', required: true },
      {
        ...
        label: 'Business Activity / HSN/SAC',
        type: 'textarea',
        required: true,
      },
      {
        key: 'turnoverEstimate',
      ...
      {
        key: 'gstPurpose',
        label: 'Purpose (New / Amendment / Cancellation)',
        type: 'select',
        required: true,
        options: [
          'New Registration',
    ...
    systemPrompt:
      'Draft a GST Registration Application covering business details, registration type, HSN/SAC codes, bank account particulars, authorized signatory, digital signature requirements, and compliance obligations post-registration under CGST Act 2017.',
  },
  ...
  'Trademark Registration': {
    ...
    fields: [
      ...
      { key: 'trademarkName', label: 'Trademark / Brand Name', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. Class 25 (Clothing), Class 42 (Software)',
      },
      {
        key: 'goodsServices',
      ...
      {
        key: 'existingRegistration',
        label: 'Existing Similar Marks (if known)',
        type: 'text',
        required: false,
      },
      {
        key: 'priority',
        label: 'Priority Claim (Paris Convention)',
        type: 'text',
        required: false,
      },
    ...
    systemPrompt:
      'Draft a Trademark Registration Application under Trade Marks Act 1999. Include TM-A application format, applicant details, mark description, class specification, goods/services, user affidavit, and statement of distinctive character. Include examination procedure notes.',
  },
  ...
  'Copyright Complaint': {
    ...
    fields: [
      ...
      {
        key: 'infringementFacts',
        label: 'Nature of Infringement',
        type: 'textarea',
        required: true,
      },
    ...
    systemPrompt:
      "Draft a Copyright Infringement Complaint/Suit under Copyright Act 1957. Include copyright ownership, originality of work, unauthorized copying/reproduction, defendant's act of infringement, damages, and prayer for injunction + damages + delivery-up + account of profits.",
  },
  ...
  'Patent Draft': {
    ...
    fields: [
      ...
      { key: 'inventionTitle', label: 'Title of Invention', type: 'text', required: true },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'e.g. Mechanical Engineering, Software, Pharmaceuticals',
      },
      {
        key: 'inventionDescription',
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'What is new and inventive about this?',
      },
      {
        key: 'priorArt',
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'What you want patent protection for...',
      },
      { key: 'inventionDate', label: 'Date of Invention', type: 'date', required: false },
    ],
    systemPrompt:
      'Draft a formal Patent Application specification under Patents Act 1970. Include title of invention, field, background/prior art, summary, detailed description, working mechanism, claims (independent + dependent), and abstract. Structure in proper patent specification format.',
  },
  ...
  'IP Infringement Notice': {
    ...
    fields: [
      ...
      { key: 'infringerName', label: 'Infringer Name / Company', type: 'text', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: ['Trademark', 'Copyright', 'Patent', 'Trade Secret', 'Design Rights'],
      },
      ...
      {
        key: 'howDiscovered',
        label: 'When/How Infringement Discovered',
        type: 'textarea',
        required: true,
      },
      { key: 'damagesSuffered', label: 'Damages Suffered', type: 'textarea', required: false },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Cease use, destroy infringing goods, account for profits, pay damages...',
      },
      { key: 'timeLimit', label: 'Time Limit to Comply', type: 'text', required: true },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ],
    systemPrompt:
      'Draft a formal Cease and Desist / IP Infringement Notice. Include IP ownership proof, infringement details, legal rights under TM Act / Copyright Act / Patents Act, demand to immediately stop infringement + destroy infringing copies + pay damages, and warning of civil + criminal proceedings.',
  },
  ...
  Affidavit: {
    ...
    fields: [
      ...
      {
        key: 'courtPurpose',
        label: 'Purpose / Before Which Authority',
        type: 'text',
        required: true,
        placeholder: 'High Court, District Court, Notary, Government Office...',
      },
      { key: 'affidavitSubject', label: 'Subject of Affidavit', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'Numbered statements to be made under oath...',
      },
    ...
    systemPrompt:
      'Draft a formal Affidavit with proper header (Affidavit format), deponent identification, statement "I, the deponent above named, do hereby solemnly affirm and declare as under:", numbered statements, oath/affirmation clause, signature space, and notary/oath commissioner attestation space.',
  },
  ...
  'RTI Application': {
    ...
    fields: [
      ...
      { key: 'applicantContact', label: 'Contact / Email', type: 'text', required: false },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Name of government department/office',
      },
      {
        key: 'pioName',
      ...
      {
        key: 'informationSought',
        label: 'Information Sought',
        type: 'textarea',
        required: true,
        placeholder: 'List specific information/documents needed — numbered points',
      },
      {
        key: 'periodCovered',
      ...
      },
      {
        ...
        type: 'select',
        required: false,
        options: ['Physical Copies', 'Electronic Copy', 'Inspection', 'Any available format'],
      },
      {
        key: 'feePaid',
        ...
        type: 'text',
        required: false,
        placeholder: '₹10 via IPO/DD/online',
      },
    ],
    systemPrompt:
      'Draft a formal RTI Application under Section 6 of the Right to Information Act 2005. Include applicant details, clear numbered information points, specific document references, reasonable time period, request for waiver if BPL, and information for filing fee payment.',
  },
  ...
  'Writ Petition': {
    ...
    fields: [
      ...
      {
        key: 'fundamentalRightsViolated',
        label: 'Fundamental Rights Violated',
        type: 'text',
        required: true,
        placeholder: 'Article 14, 19, 21...',
      },
      {
        key: 'challengedAction',
        label: 'Challenged Order / Action',
        type: 'textarea',
        required: true,
      },
  ...
  'Court Argument': {
    ...
    fields: [
      ...
      {
        key: 'clientSide',
        label: 'Arguments On Behalf Of',
        type: 'select',
        required: true,
        options: ['Plaintiff / Petitioner', 'Defendant / Respondent', 'Accused', 'Intervenor'],
      },
      ...
      {
        key: 'caseLawsCited',
        label: 'Case Laws / Precedents Cited',
        type: 'textarea',
        required: false,
      },
    ...
    systemPrompt:
      "Draft comprehensive Written Arguments / Synopsis for submission before court. Include case identification, issues framed, factual synopsis, legal propositions with supporting case law citations, rebuttal of opponent's arguments, and conclusion with prayer.",
  },
  ...
  'Evidence Summary': {
    ...
    fields: [
      ...
      { key: 'courtName', label: 'Court Name', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'List all documents with Exhibit numbers — Ex. A, Ex. B...',
      },
      {
        key: 'witnessEvidence',
        ...
        type: 'textarea',
        required: false,
        placeholder: 'List witnesses and their testimony summary...',
      },
      {
        key: 'forensicEvidence',
        label: 'Forensic / Expert Evidence',
        type: 'textarea',
        required: false,
      },
      {
        key: 'electronicEvidence',
      ...
      {
        key: 'evidenceSummary',
        label: 'Evidence Analysis / How it Proves Case',
        type: 'textarea',
        required: true,
      },
      { key: 'advocateName', label: 'Advocate Name', type: 'text', required: true },
    ...
    systemPrompt:
      'Draft a comprehensive Evidence Summary / Exhibit List for court submission. Organize evidence into categories (documentary, oral, forensic, electronic), number each exhibit, explain relevance and how each piece proves the case, and include chain of custody notes for key exhibits.',
  },
  ...
  'Legal Research': {
    ...
    fields: [
      ...
      { key: 'applicableLaws', label: 'Applicable Laws / Acts', type: 'textarea', required: false },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Indian courts / Specific State / International',
      },
...
export function getTemplate(draftType) {
  return (
    DRAFT_TEMPLATES[draftType] || {
      category: 'GENERAL',
      courtHeader: 'LEGAL DOCUMENT',
      fields: [
        {
          key: 'petitionerName',
          label: 'Party Name (Petitioner/Plaintiff)',
          type: 'text',
          required: true,
        },
        ...
        {
          key: 'incidentDate',
          label: 'Incident / Transaction Date',
          type: 'date',
          required: false,
        },
        {
          ...
          type: 'textarea',
          required: true,
          placeholder: 'Detailed factual background...',
        },
        {
          key: 'legalGrounds',
          label: 'Legal Grounds / Sections',
          type: 'textarea',
          required: false,
        },
...
export const GENERATION_MODES = [
  {
    ...
    icon: '📄',
    description: 'Standard legal draft',
    color: 'indigo',
  },
  {
    id: 'enhanced',
    label: 'Enhanced Draft',
    icon: '⚡',
    description: 'Enhanced with case laws & precedents',
    color: 'violet',
  },
  {
    id: 'court_ready',
    label: 'Court-Ready Draft',
    icon: '⚖️',
    description: 'Full official court format',
    color: 'purple',
  },
  {
    id: 'hindi',
  ...
  },
  {
    ...
    icon: '🌐',
    description: 'Generate in English',
    color: 'blue',
  },
  {
    id: 'bilingual',
    label: 'Bilingual Version',
    icon: '🔀',
    description: 'Hindi + English both',
    color: 'green',
  },
];
