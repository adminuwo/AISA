...
export const LEGAL_CASE_DATABASE = [
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Injunctions under the Specific Relief Act should follow settled principles of the Code of Civil Procedure.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Civil dispute seeking execution of contract terms and specific performance where monetary compensation is inadequate.',
    keywords: [
  ...
  },
  {
    ...
    applicableActs: [
      ...
      {
        name: 'Indian Penal Code (IPC) / Bharatiya Nyaya Sanhita (BNS)',
        enactmentYear: '1860 / 2023',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          "Established the 'rarest of rare cases' doctrine for awarding death sentence in murder cases.",
        landmarkStatus: true,
      },
      {
    ...
    summary:
      'Prosecution for commission of murder, homicide definitions, and statutory punishments under criminal code.',
  ...
  },
  {
    ...
    landmarkJudgments: [
      ...
      },
      {
        ...
        legalPrinciple:
          "Established the 'Basic Structure Doctrine' limiting amendments to the Constitution.",
        landmarkStatus: true,
      },
    ],
    summary:
      'Constitutional writ petition enforcement, violation of fundamental rights, and interpretation of state powers.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Upheld constitutionality of Section 9 of the Hindu Marriage Act regarding conjugal rights.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Matrimonial dispute involving restoration of cohabitation and claim of financial support for dependents.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Daughters have equal coparcenary rights in joint Hindu family property by birth.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Civil suit claiming partition and individual possession share of ancestral or inherited coparcenary property.',
    keywords: [
      'partition suit',
      'ancestral property',
      'coparcener',
  ...
  },
  {
    ...
    applicableActs: [
      {
        name: 'Insolvency and Bankruptcy Code (IBC)',
        enactmentYear: '2016',
        lastAmendmentYear: '2023',
      },
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Upheld the validity of the Insolvency and Bankruptcy Code, prioritizing creditor resolution.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Resolution process initiated by financial or operational creditors for recovery of unpaid corporate debts.',
  ...
  },
  {
    ...
    summary:
      'Commercial litigation seeking execution of an domestic or foreign arbitral award under civil procedure norms.',
  ...
  },
  {
    ...
    applicableActs: [
      ...
      {
        name: 'Labour Code on Industrial Relations',
        enactmentYear: '2020',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          "Wide interpretation of the term 'Industry' to include municipal utilities and education bodies.",
        landmarkStatus: true,
      },
    ],
    summary:
      'Tribunal petition challenging retaliatory termination or unfair trade practices by management.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          "Medical services fall under the scope of 'service' defined in Consumer Protection laws.",
        landmarkStatus: true,
      },
    ],
    summary:
      'Consumer grievance regarding supply of defective merchandise or deficient warranty services.',
    keywords: [
      'consumer protection',
      'medical negligence',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Transfer of shares between offshore holding companies is not subject to tax withholding in India.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Challenge against arbitrary tax assessment orders, capital gains claims, and statutory exemptions.',
    ...
    ipcBnsReferences: [
      {
        ...
        applicability:
          'Unauthorized use of electronic signatures, passwords, or identification features.',
      },
    ],
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Struck down Section 66A of the IT Act, upholding freedom of speech in cyberspace.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Offenses relating to hacking, unauthorized access, identity impersonation, and phishing scams.',
  ...
  },
  {
    ...
    applicableActs: [
      ...
      {
        name: 'Recovery of Debts Due to Banks Act',
        enactmentYear: '1993',
        lastAmendmentYear: '2018',
      },
    ],
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Upheld SARFAESI provisions but permitted borrowers to approach Debt Recovery Tribunals.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Proceedings initiated by banks for attachment and auction of mortgaged assets of defaulting borrowers.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Insurance companies cannot arbitrarily refuse renewal of policies or repudiate claims.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Dispute over arbitrary rejection of claims by insurance providers citing exclusion clauses.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          "Introduced the concept of 'Absolute Liability' for hazardous industrial units.",
        landmarkStatus: true,
      },
      {
        ...
        legalPrinciple:
          "Uphold 'Precautionary Principle' and 'Polluter Pays Principle' as part of environmental law.",
        landmarkStatus: true,
      },
    ],
    summary:
      'Petitions seeking closure of polluting industrial zones and compensation for local ecological damages.',
    keywords: [
      'ngt',
      'oleum gas leak',
      'absolute liability',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Higher burden of protection against deceptive similarity in medicinal products.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Infringement suit seeking permanent injunction against counterfeit products copying a brand.',
    keywords: [
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Homebuyers have absolute right to claim refund of principal with interest for delays.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Action filed by flat owners seeking interest refunds for default in construction timelines by builder.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          "Expanded 'public policy of India' to include patent illegality as a ground to challenge awards.",
        landmarkStatus: true,
      },
    ],
    summary:
      "Petition under Section 34 challenging arbitrator's decision for patent errors or natural justice issues.",
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Prescribed strict guidelines to prevent custodial torture and protect rights of detainees.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Public interest petition demanding accountability, judicial enquiry, and damages for police brutality.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Upheld validity of 25% free seats reservation for weaker sections in private schools.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Writ seeking directives to private academies failing to fill mandated free seats for underprivileged children.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Immediate disqualification of elected representatives convicted of offenses with 2+ years jail.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Challenge of legislative poll results alleging cash for votes or hidden asset disclosures.',
    keywords: [
      'poll malpractice',
      'disqualification',
      'lily thomas',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Absolute power of Union government to deport foreign nationals subject to due procedure.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Petition seeking stay on extradition or deportation order of asylum seekers claiming threat in home nation.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Affirmed the mandatory right to consular access under Vienna Convention on Consular Relations.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Legal actions before international organs involving state boundaries, bilateral treaties, or consular access.',
  ...
  },
  {
    ...
    jurisdiction: 'Union of India',
    applicableActs: [{ name: 'Competition Act', enactmentYear: '2002', lastAmendmentYear: '2023' }],
    ipcBnsReferences: [],
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Established relevant turnover doctrine for imposing penalties under antitrust laws.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Investigation into anti-competitive agreements, price-fixing collusions, or predatory market practices.',
  ...
  },
  {
    ...
    applicableActs: [
      {
        name: 'Cable Television Networks (Regulation) Act',
        enactmentYear: '1995',
        lastAmendmentYear: '2023',
      },
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Freedom of speech includes the right to circulate and publish views without pre-censorship.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Challenge of executive gag orders or state bans restricting telecasts or print publications.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Wiretapping violates privacy unless justified by strict statutory procedures and authorization.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Petitions arguing excessive or unauthorized traffic surveillance and data seizure by central agencies.',
  ...
  },
  {
    ...
    summary:
      'Action alleging organ donation protocol violations or leaking of sensitive clinical histories.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Standardized guidelines for calculation of future prospects in motor accident deaths.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Action before MACT claiming insurance payoffs for death/injury resulting from reckless commercial transport.',
  ...
  },
  {
    ...
    summary:
      'Contested sales under contract farming, crop quality rejections, or defaults by wholesale buyers.',
  ...
  },
  {
    ...
    applicableActs: [
      {
        name: 'Multi-State Co-operative Societies Act',
        enactmentYear: '2002',
        lastAmendmentYear: '2023',
      },
    ],
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Cooperative societies are not public authorities under the Right to Information (RTI) Act unless state-funded.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Petition challenging manipulation of voter lists or mis-appropriations of assets by committee heads.',
  ...
  },
  {
    ...
    applicableActs: [
      {
        name: 'Constitution of India (Article 32 & 226)',
        enactmentYear: '1950',
        lastAmendmentYear: '2023',
      },
    ],
    ...
    summary:
      'Social action petition filed on behalf of vulnerable classes seeking basic services and survival support.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Decisions of Administrative Tribunals are subject to judicial review by High Courts under Article 226.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Challenge of arbitrary transfer policies, demotion orders, or withholding of retirement funds.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Natural justice rules apply to administrative as well as quasi-judicial actions.',
        landmarkStatus: true,
      },
      {
        ...
        legalPrinciple:
          'Administrative orders affecting life or liberty must be just, fair, and reasonable.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Petition seeking review of executive agency orders violating basic tenets of fair hearing.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Right to livelihood is part of Article 21, requiring fair notice before evictions/demolitions.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Dispute over arbitrary building demolition notices issued without prior opportunity to reply.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Mutation entries are only for tax collection and do not confer title or ownership rights.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Appeal against mutation corrections or entries based on contested wills or partition titles.',
  ...
  },
  {
    ...
    applicableActs: [
      {
        name: 'Right to Fair Compensation in Land Acquisition Act',
        enactmentYear: '2013',
        lastAmendmentYear: '2018',
      },
    ],
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Clarified conditions for lapse of land acquisition under Section 24 of the 2013 Act.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Suit claiming enhanced payouts for ancestral holdings forcibly acquired for state development.',
    ...
    ipcBnsReferences: [
      {
        ...
        punishment:
          'Simple imprisonment up to 2 years, or with fine, or both (under BNS, community service is added).',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Upheld constitutional validity of criminal defamation provisions in Section 499/500 IPC.',
        landmarkStatus: true,
      },
    ],
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Prosecution must present concrete proof of criminal conspiracy and illegal enrichment in administrative awards.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Investigation into company fund diversions and shell entities run by senior officials.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Bail considerations in economic/corruption offenses should balance liberty with risk of investigation tampering.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Trap cases where officials are caught receiving bribes for granting public approvals.',
    ...
    ipcBnsReferences: [
      {
        ...
        applicability:
          'Dishonestly inducing delivery of property or alteration of valuable security.',
      },
    ],
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Economic offenses require strict interpretation of penal provisions due to societal impact.',
        landmarkStatus: true,
      },
    ],
  ...
  },
  {
    ...
    applicableActs: [
      {
        name: 'Banning of Unregulated Deposit Schemes Act',
        enactmentYear: '2019',
        lastAmendmentYear: '2019',
      },
    ],
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          "Affirmed SEBI's jurisdiction to regulate public debt offerings and order refunds for unauthorized deposits.",
        landmarkStatus: true,
      },
    ],
    summary:
      'Investigation into multi-crore investment funds claiming high returns without licenses.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Upheld the validity of PMLA provisions including ED powers of arrest, search, and reverse burden of proof.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Enforcement Directorate attachment actions over assets traced to criminal source origins.',
    keywords: [
      'pmla',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Section 50 search directives of NDPS are mandatory; failure vitiates the recovery trial.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Trial for trafficking illegal drugs where bail is barred due to commercial weight requirements.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Formulated initial guidelines to combat workplace sexual harassment, leading to the POSH Act.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Action filed against corporate entity failing to construct inquiry organs for gender disputes.',
    keywords: [
      'posh act',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Advocated swift investigations and dedicated fast track court procedures in child assault trials.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Criminal trial involving serious offenses against minor children where reverse onus rules apply.',
  ...
  },
  {
    ...
    summary:
      'Application seeking residential safety, restraint orders against spouse, and monthly maintenance.',
    keywords: [
      'domestic violence',
      'cruelty',
      'dowry harassment',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Upheld the age limit of 18 years for juvenile offender categorization under rehabilitation law.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Enquiry to determine age of offender and eligibility for reformation programs instead of prison.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'The 6-month statutory waiting period in mutual consent divorce can be waived by family courts.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Joint petition seeking decree of divorce with waiver of cooling period under HMA Section 13B(2).',
    keywords: [
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Succession laws clarify that coparcenary assets pass to heirs according to prevailing statutory rules.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Petition claiming certificate for recovery of debts and securities of a person who died intestate.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Established standard rules of proof for establishing the execution of a valid will.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Suit to validate execution of a last testament and grant administration authority to executor.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Earnest money forfeiture requires proof of actual loss unless genuine liquid damage is pre-agreed.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Litigation for recovery of security deposits and losses from non-performance of supply orders.',
    keywords: [
      'liquidated damages',
      'breach contract',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Housing construction services fall under consumer laws; authorities can be penalised for harassment.',
        landmarkStatus: true,
      },
    ],
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'One-sided clauses in builder-buyer agreements constitute unfair trade practices.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Flat buyers challenging builder demand notes seeking extra payments for non-sanctioned area alterations.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Non-compete covenants extending past the employment term are void under Section 27 of the Contract Act.',
        landmarkStatus: true,
      },
    ],
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Corporate liability can be invoked to seek stays on cyber harassment campaigns originating internally.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Criminal action against syndicates deploying sim clone strategies to transfer bank balances.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Addressed director liability for obscene/scam materials hosted on online retail portals.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Prosecution of domain aggregators hosting cloned websites to obtain user card numbers.',
    ...
    landmarkJudgments: [
      {
        ...
        legalPrinciple:
          'Laid the foundation for data sovereignty, mandating consent frameworks for data processing.',
        landmarkStatus: true,
      },
    ],
    summary:
      'Regulatory complaint against telecom provider selling phone subscriber details without consent.',
...
export const searchAndFilterCases = (query = '', filters = {}, page = 1, pageSize = 8) => {
  ...
  if (normQuery) {
    result = result.filter(c => {
      ...
      const matchActs = c.applicableActs?.some(
        act => act.name?.toLowerCase().includes(normQuery) || act.enactmentYear?.includes(normQuery)
      );

      const matchIpcBns = c.ipcBnsReferences?.some(
        ref =>
      ...
      const matchLandmark = c.landmarkJudgments?.some(
        j =>
  ...
  if (filters) {
    ...
    if (filters.act) {
      result = result.filter(c =>
        c.applicableActs?.some(act => act.name?.toLowerCase().includes(filters.act.toLowerCase()))
      );
    }
    if (filters.jurisdiction) {
      result = result.filter(c =>
        c.jurisdiction?.toLowerCase().includes(filters.jurisdiction.toLowerCase())
      );
    }
    if (filters.state) {
      result = result.filter(
        c =>
          ...
          c.jurisdiction?.toLowerCase().includes('state')
      );
    }
    if (filters.ipcBns) {
      result = result.filter(c =>
        c.ipcBnsReferences?.some(
          ref =>
