        ...
        <div className="flex items-center gap-6 text-left">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h1 className="text-3xl font-black text-maintext tracking-tight uppercase italic">
                AISA <span className="text-primary italic">BASE</span>
              </h1>
            ...
            <p className="text-subtext text-sm font-bold mt-1 max-w-md">
              The core intelligence center of AISA. Upload documents and crawl websites to power
              your custom AI knowledge base.
            </p>
          </div>
        </div>
