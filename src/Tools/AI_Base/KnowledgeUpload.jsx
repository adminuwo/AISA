    ...
    <div className="w-full bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/30 dark:border-white/10 rounded-2xl p-5 transition-all">
      <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
        <div className="flex-1 text-left">
          <h2 className="text-xl font-bold text-maintext">AISA RAG Knowledge Base</h2>
        ...
        <div className="flex flex-col items-end gap-3">
          <div className="flex items-center gap-3 bg-white/10 p-1.5 rounded-xl border border-white/10">
            <span className="text-[10px] font-black uppercase tracking-widest text-subtext ml-2">
              Target Category:
            </span>
            <select
              value={category}
        ...
        <AnimatePresence mode="wait">
          {!uploadStatus && activeTab === 'file' && (
            ...
            >
              {!file && (
                <div
                  className={`relative w-full h-64 border-2 border-dashed rounded-2xl flex flex-col items-center justify-center transition-all duration-300 ease-out cursor-pointer group hover:bg-slate-800/50 ${
                    isDragActive
                ...
                <div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="text-slate-200 font-medium truncate max-w-[200px] sm:max-w-xs">
                          {file.name}
                        </p>
              ...
              <div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl">
                <div className="mb-6">
                  ...
                  <p className="text-[10px] text-slate-500 mt-2">
                    Tip: Provide a root domain (e.g., https://example.com) to automatically crawl up
                    to 20 internal pages.
                  </p>
                </div>
