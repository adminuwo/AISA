      ...
      <div className="bg-white dark:bg-[#1A1A1A] w-full max-w-md rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-5 overflow-y-auto">
              ...
              <div className="flex gap-2">
                ...
                <select
                  ...
                  onChange={e => {
                    ...
                    setFormData({
                      ...formData,
                      date: `${y}-${m}-${e.target.value.toString().padStart(2, '0')}`,
                    });
                  }}
                >
                ...
                <select
                  ...
                  onChange={e => {
                    ...
                    setFormData({
                      ...formData,
                      date: `${y}-${e.target.value.toString().padStart(2, '0')}-${d}`,
                    });
                  }}
                >
                  {[
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 flex items-center gap-1">
                <Repeat className="w-3 h-3" /> {t('repeatLabel')}
              </label>
              <select
          ...
          <button
            type="submit"
            className="w-full py-3 bg-primary text-white rounded-xl font-semibold hover:bg-primary/90 transition-colors mt-2"
          >
            {t('saveTask')}
          </button>
        </form>
