      ...
      <div className="relative w-full max-w-[420px] px-4">
        ...
        >
          ...
          <div className="mb-10">
            ...
            <h2 className="text-3xl font-black text-slate-800 dark:text-white mb-2 tracking-tighter uppercase leading-tight">
              Verify Your Email
            </h2>
            <div className="flex flex-col items-center gap-1">
              ...
              <div className="flex items-center gap-2.5 px-3.5 py-1.5 bg-white/40 dark:bg-white/5 rounded-full border border-white/40 dark:border-white/10 mt-2">
                ...
                <Link
                  to="/signup"
                  className="p-1 hover:bg-white/40 dark:hover:bg-white/10 rounded-full transition-colors text-primary"
                >
