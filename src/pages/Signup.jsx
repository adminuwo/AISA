        ...
        >
          ...
          <div className="relative overflow-hidden bg-white/10 dark:bg-white/[0.04] backdrop-blur-[64px] border border-white/60 dark:border-white/10 py-6 px-8 rounded-[2.5rem] shadow-[0_32px_120px_-20px_rgba(0,0,0,0.12)] text-center ring-1 ring-white/30 transition-all hover:bg-white/15 dark:hover:bg-white/[0.06] group/card">
            ...
            <div className="text-center mb-5 relative">
              <h2 className="text-2xl font-black text-slate-800 dark:text-white mb-1.5 tracking-tighter uppercase">
                {t('createAccount')}
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-3 mt-2 px-1">
                ...
                <label
                  htmlFor="terms-agree"
                  className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed cursor-pointer select-none"
                >
                  I agree to the{' '}
                  <button
                    type="button"
                    ...
                    className="text-primary hover:underline font-semibold bg-transparent border-0 p-0 align-baseline cursor-pointer"
                  >
                    Terms of Service
                  </button>
                  ,{' '}
              ...
              <motion.button
                ...
                className={`w-full py-2.5 rounded-2xl font-bold text-sm text-white shadow-xl transition-all duration-300 flex items-center justify-center gap-2 mt-4 ${
                  agreedToTerms
            ...
            <div className="mt-6 pt-4 border-t border-white/10 dark:border-slate-800/50 text-center text-xs font-bold text-slate-400 tracking-wide uppercase relative">
              ...
              <Link
                to="/login"
                className="text-primary hover:underline ml-1 uppercase tracking-widest font-black"
              >
                {t('logIn')}
              </Link>
            </div>
          ...
          <Link
            to="/"
            className="mt-4 mb-4 flex items-center justify-center gap-2 text-slate-300 hover:text-slate-500 font-black text-[10px] uppercase tracking-widest transition-all group"
          >
