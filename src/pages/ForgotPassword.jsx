    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden selection:bg-primary/20 bg-[#f8fafc] dark:bg-[#020617] aisa-scalable-text">
      ...
      <div className="relative w-full max-w-[440px] px-4 flex flex-col items-center">
        ...
        >
          ...
          <div className="mb-10">
            <div
              className={`inline-flex items-center justify-center p-5 rounded-[2rem] mb-6 shadow-xl transition-all duration-500 ${step === 1 ? 'bg-primary shadow-primary/20' : 'bg-green-600 shadow-green-600/20'}`}
            >
              {step === 1 ? (
          ...
          <div className="mt-10 pt-8 border-t border-white/10 dark:border-slate-800/50">
            <Link
              to="/login"
              className="flex items-center justify-center gap-2 text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300 font-black text-[10px] uppercase tracking-widest transition-all group"
            >
