...
const Chat = () => {
  ...
  const handleUseInArgument = (argument) => {
    ...
    setLegalView('CHAT');
    // We don't necessarily want to reset the whole legal toolkit context, 
    // but we want to show the chat where the argument is now inserted.
  ...
  const handleLegalPrecedentsBack = () => {
    // Reset all Legal Toolkit states to return to the main AI Dashboard
    setLegalView('CHAT');
    setCurrentMode('NORMAL_CHAT');
    setSelectedLegalTool(null);
    setCurrentCase(null);
                      ...
                      {isToolsMenuOpen && (
                        ...
                        >
                          ...
                          <div className="p-1.5 pb-12 space-y-1 overflow-y-auto scrollbar-hide scroll-smooth will-change-transform" style={{ maxHeight: 'calc(100vh - 220px)' }}>
                            ...
                            >
                              <div className={`w-11 h-11 rounded-2xl border-2 flex items-center justify-center transition-all shrink-0 tool-icon-premium ${isMagicImageModalOpen ? 'bg-primary border-primary text-white' : 'bg-slate-50 dark:bg-zinc-800 border-white dark:border-zinc-700 text-slate-600 dark:text-slate-300'}`}>
