      ...
      >
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-72 border-r border-gray-100 dark:border-white/5 bg-[#FBFCFE] dark:bg-[#0E1220]/50 p-6 space-y-2 overflow-y-auto hidden md:block">
            <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-6 px-4">
              Categories
            </div>
            {faqs.map((cat, idx) => (
              <button
              ...
              >
                {cat.category}
                <ChevronRight
                  className={`w-4 h-4 transition-transform ${selectedFaqCategory === idx && activeTab === 'faq' ? 'translate-x-1' : 'opacity-0 group-hover:opacity-100'}`}
                />
              </button>
            ))}
            ...
            <div className="pt-10">
              <button
                ...
                className={`w-full text-left px-5 py-4 rounded-2xl text-xs font-black uppercase tracking-wider transition-all flex items-center gap-3 ${
                  activeTab === 'help' ? 'text-primary' : 'text-slate-400'
                }`}
              >
              ...
              {activeTab === 'faq' ? (
                <div className="max-w-3xl mx-auto space-y-12">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-sm font-black text-primary uppercase tracking-[0.3em] mb-8">
                      {faqs[selectedFaqCategory].category} Questions
                    </h3>
                    {faqs[selectedFaqCategory].questions
                      ...
                      .map((faq, index) => (
                        ...
                        >
                          ...
                          >
                            <span className="font-bold text-slate-800 dark:text-white text-[15px] group-hover:text-primary transition-colors">
                              {faq.question}
                            </span>
                            <div
                              className={`p-2 rounded-lg transition-all ${openFaqIndex === index ? 'bg-primary/10 text-primary rotate-180' : 'bg-slate-50 dark:bg-white/5 text-slate-400 group-hover:text-primary'}`}
                            >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          <ChevronDown
                            className={`w-5 h-5 text-slate-400 transition-transform ${isIssueDropdownOpen ? 'rotate-180' : ''}`}
                          />
                        </button>
