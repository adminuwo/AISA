...
const CookieConsentBanner = () => {
  ...
  const isLegalPage = /^\/(privacy-policy|terms|cookie-policy|terms-of-service)(\/|$)/i.test(
    location.pathname
  );
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[13px] text-gray-700 dark:text-gray-300 leading-relaxed mb-4 font-medium">
                    AISA™ uses cookies to improve your experience, store preferences, and analyze
                    usage. Please choose an option below to continue to the platform.{' '}
                    <button
                              ...
                              >
                                <span
                                  className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow-md transition-all duration-300 ${
                                    option.enabled ? 'left-[26px]' : 'left-0.5'
                                  }`}
                                />
                              </button>
                            )}
