      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div
              className="absolute top-[-20%] left-[-10%] w-[60%] h-[100%] rounded-full blur-[120px] animate-pulse"
              style={{ background: isDarkMode ? 'rgba(59,130,246,0.15)' : 'rgba(99,102,241,0.08)' }}
            />
            <div
              className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[100%] rounded-full blur-[100px]"
          ...
          >
            <X
              ...
              style={{ color: isDarkMode ? 'rgba(255,255,255,0.7)' : '#6366f1' }}
            />
          </button>
            ...
            <motion.h2
              ...
              style={{
                backgroundImage: isDarkMode
                  ? 'linear-gradient(to bottom, #fff, rgba(255,255,255,0.6))'
            ...
            {sections.map((sec, i) => (
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div
                    className="w-12 h-12 flex items-center justify-center rounded-2xl transition-transform duration-500 group-hover:scale-110"
                    style={{
                      background: isDarkMode ? 'rgba(59,130,246,0.1)' : 'rgba(99,102,241,0.08)',
                      color: '#3b82f6',
                    }}
                  >
                    {sec.icon}
                ...
                <p
                  ...
                  style={{ color: isDarkMode ? 'rgba(203, 213, 225, 0.7)' : '#475569' }}
                >
                  {sec.content}
                </p>
              </motion.div>
          ...
          <div className="space-y-10">
            <div className="flex items-center gap-4">
              <div
                ...
                style={{
                  background: isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(99, 102, 241, 0.2)',
                }}
              />
              <span
              ...
              {features.map((feat, i) => (
                ...
                >
                  <div
                    ...
                    style={{
                      background: isDarkMode ? 'rgba(59,130,246,0.05)' : 'rgba(99,102,241,0.05)',
                      color: '#3b82f6',
                    }}
                  >
                    {feat.icon}
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ color: isDarkMode ? 'rgba(203, 213, 225, 0.6)' : '#64748B' }}
                    >
                      {feat.desc}
                    </p>
                  </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  ...
                  <span
                    key={i}
                    className="px-6 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-xs font-bold tracking-wide transition-colors backdrop-blur-md"
                  >
                    {label}
                  </span>
                ))}
