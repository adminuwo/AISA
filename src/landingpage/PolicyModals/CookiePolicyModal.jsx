  ...
  const sections = [
    {
      ...
      items: [t('cp_what_item1'), t('cp_what_item2'), t('cp_what_item3')],
    },
    {
      icon: Settings2,
      title: t('cp_types_title'),
      items: [t('cp_types_item1'), t('cp_types_item2'), t('cp_types_item3'), t('cp_types_item4')],
    },
    {
      icon: Smartphone,
    ...
    },
    {
      ...
      items: [t('cp_third_item1'), t('cp_third_item2'), t('cp_third_item3'), t('cp_third_item4')],
    },
    {
      icon: Shield,
            ...
            {loading ? (
              ...
              <>
                {dynamicSections.map((section, index) => (
                  <div
                    key={index}
                    className="bg-surface/30 rounded-2xl p-8 border border-border hover:border-primary/20 transition-all group"
                  >
              ...
              <>
                ...
                <div className="bg-surface rounded-xl p-4 border border-border">
                  <p className="text-sm text-maintext leading-relaxed">{t('cp_intro')}</p>
                </div>
                ...
                {sections.map((section, index) => (
                  <div
                    key={index}
                    className="bg-surface rounded-xl p-5 border border-border hover:border-primary/30 transition-all"
                  >
