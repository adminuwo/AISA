...
const Landing = () => {
  ...
  return (
    <div
      style={{ background: isDarkMode ? '#0b0b12' : '#EEF2FF' }}
      className="min-h-screen flex flex-col relative overflow-x-hidden aisa-scalable-text"
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="max-w-4xl w-full">
          <h2 className="text-4xl md:text-7xl font-black mb-6 text-[#0F172A] dark:text-white tracking-tight leading-[1.05]">
            {t('choosePowerLevel').split(' ').slice(0, 2).join(' ')} <br />{' '}
            <span className="text-primary italic">
              {t('choosePowerLevel').split(' ').slice(2).join(' ')}
            </span>
          </h2>
      ...
      >
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-t from-primary/5 via-transparent to-transparent transition-opacity duration-1500 ${isBloomExploded ? 'opacity-80' : 'opacity-0'}`}
        />
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-12 pt-10 pb-8 relative z-10">
          ...
          >
              ...
              >
                <div className="relative">
                  ...
                  <img
                    src={logo}
                    alt="AISA™"
                    className="w-12 h-12 relative transform group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
                <span
                  aria-label="AISA™"
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    style={{ fontSize: '0.6em', verticalAlign: 'super', marginLeft: '2px' }}
                  >
                    ™
                  </span>
                </span>
              ...
              <div className="flex items-center gap-3">
                {[
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-10 h-10 flex items-center justify-center rounded-full bg-black/5 dark:bg-white/5 hover:bg-primary/20 hover:scale-110 shadow-sm transition-all duration-300 group"
                  >
                    <img
                      src={s.img}
                      alt="social"
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              <h4 className="text-xs font-black text-primary uppercase tracking-[0.25em] pl-1 footer-link-sparkle w-fit cursor-pointer">
                {t('knowledgeHub')}
              </h4>
              <ul className="space-y-5">
                <li>
                  <button
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-primary transition-all font-bold text-sm tracking-wide footer-link-sparkle"
                  >
                    {t('helpCenter')}
                  </button>
                </li>
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <ul className="space-y-6 text-gray-600 dark:text-gray-400 text-[0.95rem] font-medium">
                ...
                <li className="flex items-center gap-4 group cursor-pointer">
                  ...
                  <a href="mailto:admin@uwo24.com" className="footer-link-sparkle">
                    admin@uwo24.com
                  </a>
                </li>
                <li className="flex items-center gap-4 group cursor-pointer">
                  ...
                  <a href="tel:+918358990909" className="footer-link-sparkle">
                    +91 83589 90909
                  </a>
                </li>
              </ul>
            ...
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <ul className="space-y-5">
                <li>
                  <Link
                    to="/privacy-policy"
                    className="inline-block text-gray-600 dark:text-gray-400 hover:text-primary transition-all font-bold text-sm tracking-wide footer-link-sparkle"
                  >
                    {t('privacyPolicy')}
                  </Link>
                </li>
          ...
          <motion.div
            ...
            className="pt-8 border-t border-black/5 dark:border-white/5 flex justify-center"
          >
            ...
            >
              <div className="px-10 py-8 border-b border-black/5 dark:border-white/5 flex justify-between items-center bg-gray-50/50 dark:bg-white/5">
                ...
                <button
                  ...
                  className="p-3 hover:bg-black/5 dark:hover:bg-white/10 rounded-2xl transition-all"
                >
              ...
              <div className="flex-1 overflow-y-auto p-10 space-y-6 custom-scrollbar">
                {faqs
                  ...
                  .map((faq, idx) => (
                    <div
                      key={idx}
                      className="border border-black/5 dark:border-white/5 rounded-3xl bg-gray-50/50 dark:bg-white/5 p-6 hover:border-primary/30 transition-all cursor-default group"
                    >
                      <button
                        onClick={() => setOpenFaqIndex(openFaqIndex === idx ? null : idx)}
                        className="w-full text-left font-black flex justify-between items-center text-gray-900 dark:text-white text-lg"
                      >
                        {faq.question}
                        <div
                          className={`p-1.5 rounded-lg bg-white dark:bg-white/5 border border-black/5 dark:border-white/5 transition-transform duration-500 ${openFaqIndex === idx ? 'rotate-180' : ''}`}
                        >
                          <ChevronDown size={18} />
                        </div>
                      </button>
