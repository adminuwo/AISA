...
const FEATURES = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        from: 'ai',
        text: '🔍 DeepSearch Engine engaged — scanning 40M+ sources...',
        typing: true,
        ms: 1000,
      },
      {
        from: 'ai',
        text: '🧠 Cross-referencing arXiv, Nature, IEEE & live web...',
        typing: true,
        ms: 900,
      },
      {
        from: 'ai',
        text: '✅ Deep Search Complete:\n• Google unveils 1M qubit chip "Willow-X".\n• IBM Quantum breaks error correction record.\n• 3 peer-reviewed papers synthesized.',
        card: 'search',
        ms: 1200,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        from: 'ai',
        text: '🎨 AISA Imagine™ activated — crafting prompt blueprint...',
        typing: true,
        ms: 900,
      },
      {
        from: 'ai',
        text: '⚡ Rendering with FLUX Ultra + VEO-3 pipeline...',
        typing: true,
        ms: 1200,
      },
      {
        from: 'ai',
        text: '✅ 8K masterpiece generated.\n📐 Resolution: 7680×4320 · Style: Cinematic Noir',
        card: 'image',
        ms: 300,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        from: 'ai',
        text: '🎬 Video Node online — compositing frames with VEO-3...',
        typing: true,
        ms: 1100,
      },
      ...
      {
        from: 'ai',
        text: '✅ Video ready — 5s · 4K · 24fps · +Spatial Audio',
        card: 'video',
        ms: 300,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        from: 'ai',
        text: '🌐 Live Web Agent active — connecting to real-time feeds...',
        typing: true,
        ms: 900,
      },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        from: 'ai',
        text: '💻 Neural Code Builder online — architecting solution...',
        typing: true,
        ms: 1000,
      },
      {
        from: 'ai',
        text: '⚙️ Generating optimized, production-ready code...',
        typing: true,
        ms: 1100,
      },
      {
        from: 'ai',
        text: '✅ Code ready — Python · 100% async · Rate-limit safe',
        card: 'code',
        ms: 300,
      },
    ],
  ...
  if (type === 'search')
    return (
      <div
        style={{
          marginTop: 8,
          background: isDarkMode ? 'rgba(96,165,250,0.08)' : 'rgba(96,165,250,0.15)',
          border: isDarkMode ? '1px solid rgba(96,165,250,0.2)' : '1px solid rgba(96,165,250,0.4)',
          borderRadius: 8,
          padding: '8px 12px',
        }}
      >
        {[
          'MIT AI Lab — LLM Reasoning 2025',
          'Stanford HAI — Foundation Models',
          'DeepMind — Gemini Ultra',
        ].map((t, i) => (
          <div
            key={i}
            style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: i < 2 ? 4 : 0 }}
          >
            <ExternalLink
              size={10}
              style={{ color: isDarkMode ? '#60a5fa' : '#3b82f6', flexShrink: 0 }}
            />
            <span
              style={{
                fontSize: '0.72rem',
  ...
  if (type === 'image' || type === 'image2')
    return (
        ...
        style={{
          ...
          background: isDarkMode
            ? type === 'image'
              ...
              : 'linear-gradient(135deg,#6a0572,#11998e,#1a1a2e)'
            : type === 'image'
              ? 'linear-gradient(135deg,rgba(167,139,250,0.1),rgba(139,92,246,0.15))'
              : 'linear-gradient(135deg,rgba(45,212,191,0.15),rgba(16,185,129,0.15))',
          display: 'flex',
          alignItems: 'center',
      ...
      >
        ...
        <Sparkles
          size={22}
          style={{ color: isDarkMode ? '#c4b5fd' : '#6d28d9', position: 'relative', zIndex: 1 }}
        />
        <span
          style={{
            marginLeft: 6,
  ...
  if (type === 'web')
    return (
      <div
        style={{
          marginTop: 8,
          background: isDarkMode ? 'rgba(45,212,191,0.07)' : 'rgba(45,212,191,0.15)',
          border: isDarkMode ? '1px solid rgba(45,212,191,0.2)' : '1px solid rgba(45,212,191,0.4)',
          borderRadius: 8,
          padding: '8px 12px',
        }}
      >
        ...
        <div
          style={{
            height: 28,
            background: isDarkMode ? 'rgba(45,212,191,0.08)' : 'rgba(45,212,191,0.1)',
            borderRadius: 5,
            display: 'flex',
            alignItems: 'center',
            paddingLeft: 8,
        ...
        >
          <span
            style={{
              fontSize: '0.68rem',
              color: isDarkMode ? 'rgba(45,212,191,0.5)' : '#0f766e',
              fontWeight: isDarkMode ? 400 : 500,
            }}
          >
            Live chart ↗ CoinGecko
          </span>
        </div>
      </div>
    );
  if (type === 'code')
    return (
      <div
        style={{
          marginTop: 8,
          background: isDarkMode ? 'rgba(5,5,20,0.9)' : 'rgba(238,242,255,1)',
          border: isDarkMode
      ...
      >
        <div
          style={{
            padding: '5px 10px',
            background: isDarkMode ? 'rgba(99,102,241,0.1)' : 'rgba(129,140,248,0.2)',
            display: 'flex',
            alignItems: 'center',
            gap: 5,
        ...
        <pre
          style={{
            ...
            padding: '8px 10px',
            fontSize: '0.62rem',
            color: isDarkMode ? '#a5b4fc' : '#312e81',
            fontWeight: 500,
            lineHeight: 1.55,
            whiteSpace: 'pre-wrap',
            overflowX: 'hidden',
    ...
    {[0, 1, 2].map(i => (
      <span
        ...
        style={{
          ...
          borderRadius: '50%',
          background: color,
          animation: `td 1s ease-in-out ${i * 0.15}s infinite`,
        }}
      />
    ))}
  </span>
  ...
  return (
    <div
      style={{
        ...
        marginBottom: 10,
        animation: 'bIn 0.25s ease forwards',
      }}
    >
      {!isUser && (
        <div
      ...
      <div
        style={{
          ...
          background: isUser
            ? `linear-gradient(135deg,${color}bb,${color})`
            : isDarkMode
  ...
  useEffect(() => {
    ...
    let ctx = gsap.context(() => {
      ...
      tl.to(glow, { opacity: 1, scale: 1, duration: 0.6, ease: 'power2.out' })
        .to(
          card,
          { scale: 1.04, opacity: 1, filter: 'blur(0px)', duration: 0.45, ease: 'power3.out' },
          '<0.1'
        )
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.12em', color: '#818cf8' }}
        >
          LIVE DEMO
        </span>
      </div>
      ...
      <p
        style={{
          color: isDarkMode ? 'rgba(148,163,184,0.65)' : '#475569',
          fontSize: '0.95rem',
          textAlign: 'center',
          maxWidth: 440,
          lineHeight: 1.6,
      ...
      >
        ...
        <div
          style={{
            ...
            gap: 7,
            padding: '11px 16px',
            borderBottom: isDarkMode ? `1px solid ${feat.color}20` : `1px solid ${feat.color}15`,
        ...
        >
          ...
          <div
            style={{
              ...
              padding: '3px 12px',
              fontSize: '0.68rem',
              color: isDarkMode ? 'rgba(148,163,184,0.5)' : '#475569',
              maxWidth: 220,
              margin: '0 auto',
              fontWeight: 500,
            }}
        ...
        >
          ...
          <ChevronRight
            size={12}
            style={{ color: isDarkMode ? 'rgba(255,255,255,0.2)' : 'rgba(15,23,42,0.2)' }}
          />
          <span
            style={{
              fontSize: '0.68rem',
              color: isDarkMode ? 'rgba(255,255,255,0.35)' : 'rgba(15,23,42,0.4)',
              fontWeight: 500,
            }}
          >
              ...
              {messages.length === 0 && (
                <div
                  style={{
                    ...
                    justifyContent: 'center',
                    gap: 10,
                    color: isDarkMode ? 'rgba(148,163,184,0.25)' : 'rgba(15,23,42,0.3)',
                    paddingBottom: 10,
                  }}
                >
        ...
        >
          <div
            style={{
              ...
              color: isDarkMode ? 'rgba(148,163,184,0.3)' : '#475569',
              fontSize: '0.78rem',
              fontWeight: 500,
            }}
          >
