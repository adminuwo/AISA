    ...
    >
      ...
      <div className="bg-[#f8f9fa] px-8 py-6 border-b border-gray-100 flex justify-between items-center">
        ...
        <div className="text-right">
          ...
          <div
            className={`flex items-center gap-1 justify-end font-bold text-sm ${isBuy ? 'text-emerald-500' : isSell ? 'text-rose-500' : 'text-amber-500'}`}
          >
      ...
      {banking_metrics && (
        ...
        >
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-sm font-black uppercase tracking-[0.2em] text-indigo-900/40">
            ...
            {[
              {
                ...
                val: banking_metrics.nim,
                color: 'bg-indigo-500',
                pct: '70%',
              },
              {
                label: 'CASA Ratio',
                val: banking_metrics.casa,
                color: 'bg-emerald-500',
                pct: '60%',
              },
              {
                label: 'Asset Quality (NPA)',
                val: banking_metrics.npa,
                color: 'bg-rose-500',
                pct: '30%',
              },
              {
                label: 'CAR (Adequacy)',
                val: banking_metrics.car,
                color: 'bg-indigo-500',
                pct: '85%',
              },
            ].map((m, i) => (
              <div
                key={i}
                className="bg-white p-5 rounded-2xl shadow-sm border border-indigo-100/50 hover:shadow-md transition-shadow"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
        ...
        <div className="md:col-span-4 p-8 border-r border-gray-100 space-y-8">
          ...
          <section
            className={`p-5 rounded-2xl border ${isBuy ? 'bg-emerald-50/50 border-emerald-100' : isSell ? 'bg-rose-50/50 border-rose-100' : 'bg-amber-50/50 border-amber-100'}`}
          >
            <div className="flex items-center gap-2 mb-2">
              <ShieldCheck
                size={18}
                className={isBuy ? 'text-emerald-500' : isSell ? 'text-rose-500' : 'text-amber-500'}
              />
            ...
            >
              ...
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
                {[
                  {
                    label: '23.6% (Weak)',
                    price: indicators.FibonacciSeries.level236,
                    color: 'text-gray-600',
                  },
                  {
                    label: '38.2% (Moderate)',
                    price: indicators.FibonacciSeries.level382,
                    color: 'text-blue-600',
                  },
                  {
                    label: '50.0% (Strong)',
                    price: indicators.FibonacciSeries.level500,
                    color: 'text-indigo-600',
                  },
                  {
                    label: '61.8% (Golden)',
                    price: indicators.FibonacciSeries.level618,
                    color: 'text-amber-600',
                  },
                  {
                    label: '78.6% (Critical)',
                    price: indicators.FibonacciSeries.level786,
                    color: 'text-rose-600',
                  },
                ].map((lvl, idx) => (
                  <div
              ...
              <p className="mt-4 text-[11px] text-gray-400 italic">
                *Levels are recalculated in real-time based on the 30-day volatility range including
            ...
            {(risk_analysis?.breakdown || []).map((risk, idx) => (
              <div key={idx} className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-md font-bold border ${getRiskColor(risk.impact)}`}
                  >
                    {risk.impact}
                  </span>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-sm font-medium text-gray-600">
                    <span className="font-bold text-gray-800">Industry Deep Dive:</span>{' '}
                    {research?.industry}
                  </p>
                </li>
                <li className="flex gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-indigo-500 shrink-0" />
                  <p className="text-sm font-medium text-gray-600">
                    <span className="font-bold text-gray-800">Segment Performance:</span>{' '}
                ...
                <li className="flex gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-indigo-500 shrink-0" />
                  <p className="text-sm font-medium text-gray-600">
                    <span className="font-bold text-gray-800">Competitor Comparison:</span>{' '}
                    {research?.competitor}
                  </p>
                </li>
              </ul>
            ...
            <section>
              ...
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <p className="text-sm font-medium text-gray-600">
                    <span className="font-bold text-gray-800">Entry Strategy:</span>{' '}
                ...
                <li className="flex gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-amber-500 shrink-0" />
                  <p className="text-sm font-medium text-gray-600">
                    <span className="font-bold text-gray-800">Investment View:</span>{' '}
                    {recommendation?.view}
                  </p>
                </li>
                <li className="flex gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-amber-500 shrink-0" />
                  <p className="text-sm font-medium text-gray-600">
                    <span className="font-bold text-gray-800">Actionable Advice:</span>{' '}
                ...
                <li className="flex gap-3">
                  <div className="mt-1 w-1.5 h-1.5 rounded-full bg-amber-500 shrink-0" />
                  <p className="text-sm font-medium text-gray-600">
                    <span className="font-bold text-gray-800">Key Monitoring Metric:</span>{' '}
