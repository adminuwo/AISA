      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        >
          <p className="text-maintext leading-relaxed mb-4">
            Welcome to {name}™. These Terms of Service ("Terms") govern your access to and use of
            our intelligent AI assistant platform, including all features, applications, content,
            and services (collectively, the "Service").
          </p>
          <p className="text-maintext leading-relaxed">
            Please read these Terms carefully. By accessing or using the Service, you acknowledge
        ...
        >
          ...
          <div className="space-y-4 text-subtext leading-relaxed">
            ...
            <div>
              ...
              <p>
                AISA™ operates in compliance with major global data protection and privacy
