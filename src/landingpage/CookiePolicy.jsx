      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">
            <strong className="text-gray-700 dark:text-gray-200">Last Updated:</strong>{' '}
            {lastUpdated}
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-800 dark:text-gray-200 leading-relaxed mb-4">
            This Cookie Policy explains how {name}™ uses cookies and similar technologies to
            recognize you when you visit our platform. It explains what these technologies are, why
            we use them, and your rights to control their use.
          </p>
          <p className="text-gray-800 dark:text-gray-200 leading-relaxed">
            By continuing to use {name}™, you consent to our use of cookies in accordance with this
            policy. You can change your cookie preferences at any time through your browser or
            account settings.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-2 text-gray-700 dark:text-gray-300">
            ...
            <p>
              <strong className="text-gray-900 dark:text-white">Address:</strong> Jabalpur, Madhya
              Pradesh, India
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            legal requirements. We will notify you of significant changes by posting a notice on our
