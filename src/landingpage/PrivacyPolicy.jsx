    ...
    <div className="min-h-screen bg-[#0F172A] selection:bg-primary/30">
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-maintext mb-4">Privacy Policy</h1>
        ...
        >
          <p className="text-maintext leading-relaxed mb-4">
            Welcome to {name}™ ("we," "our," or "us"). This Privacy Policy explains how we collect,
            use, disclose, and safeguard your information when you use our AI-powered intelligent
            assistant platform.
          </p>
          <p className="text-maintext leading-relaxed">
            By using {name}™, you agree to the collection and use of information in accordance with
            this policy. We are committed to maintaining the highest standards of privacy and
        ...
        >
          ...
          <p className="text-subtext leading-relaxed mb-4">
            AISA™ operates in compliance with major global data protection and privacy regulations.
            We are committed to upholding user rights across all jurisdictions.
          </p>
          <div className="space-y-3">
            {[
              { name: 'General Data Protection Regulation (GDPR) — EU', url: 'https://gdpr.eu/' },
              {
                name: 'California Consumer Privacy Act (CCPA) — USA',
              ...
              {
                name: 'Personal Data Protection Act (PDPA) — Singapore',
              ...
              >
                ...
                <span className="text-sm text-maintext group-hover:text-primary transition-colors">
                  {reg.name}
                </span>
              </a>
            ))}
        ...
        >
          ...
          <div className="space-y-2 text-subtext">
            <p>
              <strong className="text-maintext">Email:</strong>{' '}
              <a href="mailto:admin@uwo24.com" className="text-primary hover:underline">
                admin@uwo24.com
              </a>
            </p>
            <p>
              <strong className="text-maintext">Phone:</strong>{' '}
              <a href="tel:+918359890909" className="text-primary hover:underline">
                +91 83589 90909
              </a>
            </p>
            <p>
              <strong className="text-maintext">Address:</strong> Jabalpur, Madhya Pradesh, India
            </p>
          </div>
        </motion.div>
