        ...
        {step === 2 &&
          results.map((r, i) => (
            ...
            >
              ...
              <div>
                <div
                  style={{ fontSize: '0.72rem', color: color, fontWeight: 600, marginBottom: 2 }}
                >
                  {r.src}
                </div>
                <div
                  style={{ fontSize: '0.7rem', color: 'rgba(203,213,225,0.8)', lineHeight: 1.4 }}
                >
                  {r.title}
                </div>
              </div>
        ...
        {step === 2 && (
          <div
            style={{
              ...
              animation: 'sfBIn 0.3s ease 0.5s both',
            }}
          >
            <div style={{ fontSize: '0.68rem', color: 'rgba(148,163,184,0.5)', marginBottom: 4 }}>
              {t('aiSummary')}
            </div>
            <p
              style={{
            ...
            >
              GPT-5 chain-of-thought self-verification reduces hallucination by{' '}
              <span style={{ color, fontWeight: 700 }}>47%</span>. MoE scaling laws show efficiency
              gains.
            </p>
          </div>
        )}
    ...
    <div style={panelStyle('#f472b6')}>
      ...
      >
        ...
        {phase === 'done' && (
          ...
          >
            <div style={{ fontSize: '0.7rem', color, fontWeight: 700, marginBottom: 2 }}>
              🎬 {t('videoReady')}
            </div>
            <div style={{ fontSize: '0.68rem', color: 'rgba(203,213,225,0.6)' }}>
              5s · 4K · 24fps · Orchestral Audio ✓
            </div>
          </div>
        )}
      </div>
    ...
    <div style={panelStyle('#2dd4bf')}>
      ...
      >
        ...
        >
          ...
          {/* Mini chart bars */}
          <div
            style={{ display: 'flex', gap: 3, alignItems: 'flex-end', marginTop: 10, height: 30 }}
          >
        ...
        {news.map((item, i) => (
          ...
          >
            <div style={{ fontSize: '0.62rem', color, fontWeight: 700, marginBottom: 2 }}>
              {item.src}
            </div>
...
def google_search(query, n=10):
  ...
  return (
    <div style={panelStyle('#818cf8')}>
      ...
      <div
        style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '10px 12px', gap: 8 }}
      >
        {/* User query */}
        <div
          style={{
        ...
        {step >= 1 && (
          ...
          >
            ...
            <div style={{ fontSize: '0.7rem', color: '#fda4af' }}>
              Potential high-risk liability detected.
            </div>
          </div>
        )}
        {step >= 2 && (
          ...
          >
            <div style={{ fontSize: '0.7rem', color, fontWeight: 700, marginBottom: 4 }}>
...
const AiCashflowDemo = ({ active }) => {
  ...
  return (
    <div style={panelStyle('#34d399')}>
      ...
      <div
        style={{ flex: 1, padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 12 }}
      >
        ...
        <div
          style={{ display: 'flex', gap: 4, alignItems: 'flex-end', height: 60, padding: '0 4px' }}
        >
          {dots.map((d, i) => (
            <div
              key={i}
        ...
        >
          ...
          <div style={{ fontSize: '0.68rem', color: 'rgba(203,213,225,0.6)' }}>
            Positive trend continues. Projected 12% growth.
          </div>
        </div>
      </div>
    </div>
        ...
        >
          {step === 0 ? (
            ...
            <div style={{ animation: 'sfBIn 0.4s ease' }}>
              <div style={{ fontSize: '0.75rem', fontWeight: 800, color: '#fff', marginBottom: 4 }}>
                Slice of Heaven 🍕
              </div>
              <p
                style={{
...
const SyntaxHighlight = ({ code }) => {
  ...
  return (
    <>
      {tokens.map((tok, i) =>
        ['import', 'from', 'def', 'return', 'try', 'except', 'for', 'in', 'if', 'else'].includes(
          tok
        ) ? (
...
const features = [
  {
    ...
    title: 'Deep Search',
    description:
      'AI-powered deep internet research, going beyond simple results with comprehensive cited analysis.',
    icon: Search,
    bgFrom: 'rgba(0,24,60,1)',
    bgTo: 'rgba(0,10,30,1)',
    accentColor: '#60a5fa',
  ...
  },
  {
    ...
    title: 'Code Builder',
    description:
      'Generate, explain, and debug code across any language with a powerful AI coding assistant.',
    icon: Code2,
    bgFrom: 'rgba(10,10,60,1)',
    bgTo: 'rgba(5,5,30,1)',
    accentColor: '#818cf8',
    accentGlow: 'rgba(99,102,241,0.35)',
    Demo: CodeBuilderDemo,
  },
  {
    id: 5,
    title: 'AI Legal',
    description:
      'Advanced legal intelligence for document analysis, risk detection, and professional drafting.',
    icon: Scale,
    bgFrom: 'rgba(60,20,40,1)',
    bgTo: 'rgba(30,10,20,1)',
    accentColor: '#fb7185',
  ...
  },
  {
    ...
    title: 'AI Cashflow',
    description:
      'Intelligent financial forecasting and real-time revenue analysis for modern businesses.',
    icon: TrendingUp,
    bgFrom: 'rgba(10,50,30,1)',
    bgTo: 'rgba(5,25,15,1)',
    accentColor: '#34d399',
  ...
  },
  {
    ...
    title: 'AI Ads',
    description:
      'Automated high-conversion ad campaign generation and creative copywriting for social media.',
    icon: Megaphone,
    bgFrom: 'rgba(20,20,60,1)',
    bgTo: 'rgba(10,10,30,1)',
    accentColor: '#6366f1',
    accentGlow: 'rgba(99,102,241,0.35)',
    Demo: AiAdsDemo,
  },
        ...
        >
          {features.map((feat, index) => {
            const featTranslateKeys = {
              ...
              'AI Legal': {
                title: 'AI Legal',
                desc: 'Advanced legal intelligence for document analysis and risk detection.',
              },
              'AI Cashflow': {
                title: 'AI CashFlow',
                desc: 'Intelligent financial forecasting and real-time revenue analysis.',
              },
              'AI Ads': {
                title: 'AI Ads',
                desc: 'Automated high-conversion ad campaign generation and creative copywriting.',
              },
            };
            ...
            const translatedTitle =
              t(featTranslateKeys[feat.title]?.title) ||
              featTranslateKeys[feat.title]?.title ||
              feat.title;
            const translatedDesc =
              t(featTranslateKeys[feat.title]?.desc) ||
              featTranslateKeys[feat.title]?.desc ||
              feat.description;
            ...
            return (
              ...
              >
                ...
                <div
                  className="sf-glow-1 sf-desktop-only"
                  style={{
                    position: 'absolute',
                    top: '10%',
                    right: '-5%',
                    ...
                    height: '70vh',
                    borderRadius: '50%',
                    background: `radial-gradient(circle,${feat.accentGlow} 0%,transparent 65%)`,
                    filter: 'blur(60px)',
                    pointerEvents: 'none',
                  }}
                />
                <div
                  className="sf-glow-2 sf-desktop-only"
                  style={{
                    position: 'absolute',
                    bottom: '-10%',
                    left: '5%',
                    ...
                    height: '50vh',
                    borderRadius: '50%',
                    background: `radial-gradient(circle,${feat.accentGlow.replace('0.35', '0.1').replace('0.3', '0.08')} 0%,transparent 70%)`,
                    filter: 'blur(70px)',
                    pointerEvents: 'none',
                  }}
                />
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        border: `1px solid ${feat.accentColor}55`,
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        boxShadow: isDarkMode
                          ? `0 0 30px ${feat.accentGlow}`
                          : `0 10px 25px ${feat.accentColor}20`,
                        backdropFilter: isDarkMode ? 'none' : 'blur(12px)',
                      }}
                    >
                  ...
                  {features.map((_, i) => (
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: 2,
                        width: i === index ? 28 : 7,
                        background: i === index ? feat.accentColor : 'rgba(255,255,255,0.2)',
                ...
                <div
                  ...
                  style={{
                    ...
                    fontWeight: 900,
                    lineHeight: 1,
                    color: isDarkMode ? 'rgba(255,255,255,0.025)' : 'rgba(79, 70, 229, 0.04)',
                    userSelect: 'none',
                    pointerEvents: 'none',
                    zIndex: 0,
                  }}
