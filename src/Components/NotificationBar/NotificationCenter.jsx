        ...
        <div className="p-6 border-b border-white/5 flex items-center justify-between sticky top-0 z-10 bg-inherit/80 backdrop-blur-md">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-subtext font-bold uppercase tracking-widest">
                AISA™ System Updates
              </p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="p-2 hover:bg-white/5 rounded-full transition-colors text-subtext hover:text-maintext"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            {loading ? (
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2 mb-1">
                          <h4
                            className={`text-sm font-bold truncate ${notif.isRead ? 'text-subtext' : 'text-maintext'}`}
                          >
                            {notif.title}
                          </h4>
                          {!notif.isRead && (
                            <span className="w-2 h-2 bg-primary rounded-full shrink-0 animate-pulse"></span>
                          )}
                        </div>
                        <p
                          className={`text-xs leading-relaxed line-clamp-3 ${notif.isRead ? 'text-subtext/70' : 'text-subtext'}`}
                        >
                          {notif.desc}
                        </p>
              ...
              >
                ...
                <p className="text-xs text-subtext mt-2 leading-relaxed">
                  No new notifications from AISA™ at the moment. We'll alert you here for reminders
                  or system updates.
                </p>
              </motion.div>
            )}
