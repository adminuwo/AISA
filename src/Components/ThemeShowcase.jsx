      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground font-medium">
            Dynamic design tokens applied globally.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-4 p-6 bg-card rounded-3xl border border-border/50 shadow-sm">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`w-4 h-4 rounded-full bg-white transition-transform duration-300 shadow-sm ${toggle ? 'translate-x-6' : 'translate-x-0'}`}
                />
              </button>
            </div>
            ...
            <div className="flex gap-2">
              {[1, 2, 3].map(i => (
                <div
                  key={i}
                  className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${i === 1 ? 'bg-primary text-white' : 'bg-muted text-muted-foreground hover:bg-primary/10 hover:text-primary cursor-pointer'}`}
                >
                  {i}
                </div>
              ))}
        ...
        <div className="space-y-4 p-6 bg-card rounded-3xl border border-border/50 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <span className="px-2 py-1 bg-primary/10 text-primary text-[10px] font-black rounded-md uppercase tracking-widest border border-primary/20">
                New
              </span>
              <span className="px-2 py-1 bg-primary text-white text-[10px] font-black rounded-md uppercase tracking-widest">
                Premium
              </span>
            </div>
          </div>
