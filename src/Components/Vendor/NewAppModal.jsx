                ...
                >
                  ...
                  <div className="relative p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div
                        className={`p-2.5 rounded-lg ${pricingConfig ? 'bg-blue-100 text-blue-600' : 'bg-white/20 text-white backdrop-blur-sm'}`}
                      >
                        {pricingConfig ? (
                      ...
                      <div className="text-left">
                        <span
                          className={`block text-base font-black tracking-tight ${pricingConfig ? 'text-gray-900' : 'text-white'}`}
                        >
                          {pricingConfig ? 'Subscription Configured' : 'Set Subscription Pricing'}
                        </span>
                        <span
                          className={`text-xs font-medium mt-0.5 block ${pricingConfig ? 'text-gray-500' : 'text-blue-100'}`}
                        >
                          {pricingConfig
                    ...
                    <div
                      className={`p-1.5 rounded-lg transition-colors ${pricingConfig ? 'text-gray-400' : 'text-white/70 group-hover:text-white group-hover:bg-white/10'}`}
                    >
                      {pricingConfig ? (
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-4 flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium leading-relaxed">
                  Your app will be created as a Draft and won't be visible on the marketplace until
                  you publish it from the dashboard.
                </p>
              </div>
            </div>
