                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="text-sm font-medium text-gray-900 group-hover:text-blue-600 transition-colors">
                        {app.agentName || app.name}
                      </div>
                      <ChevronRight
                        size={14}
                        className="ml-2 text-gray-300 opacity-0 group-hover:opacity-100 transition-all transform translate-x-0 group-hover:translate-x-1"
                      />
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      {app.reviewCount > 0 && (
                        <span className="text-xs text-gray-400 ml-1">({app.reviewCount})</span>
                      )}
                    </div>
                  </td>
                </tr>
