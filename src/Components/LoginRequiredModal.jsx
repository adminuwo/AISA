      ...
      {isOpen && (
        ...
        >
          ...
          >
            {/* Background glows */}
            <div
              className={`absolute -top-32 -right-32 w-64 h-64 rounded-full blur-[120px] pointer-events-none ${
                isDark ? 'bg-primary/20' : 'bg-primary/10'
              }`}
            />
            <div
              className={`absolute -bottom-32 -left-32 w-64 h-64 rounded-full blur-[130px] pointer-events-none ${
            ...
            <div className="flex justify-between items-start mb-10">
              <div
                className={`w-[72px] h-[72px] rounded-[24px] flex items-center justify-center ${
                  isDark
            ...
            {/* Text Content */}
            <h3
              className={`text-[32px] font-black mb-4 tracking-tight leading-tight ${
            ...
            <p
              className={`text-[16px] mb-12 leading-relaxed font-medium ${
            ...
            <div className="space-y-4">
              ...
              >
                <LogIn
                  className="w-5.5 h-5.5 transition-transform group-hover:translate-x-1"
                  strokeWidth={2.5}
                />
                Log In Now
              </motion.button>
              ...
              >
                <UserPlus
                  className={`w-5.5 h-5.5 ${isDark ? 'text-white/80' : 'text-slate-500'}`}
                  strokeWidth={1.5}
                />
                Create Account
              </motion.button>
            ...
            <button
              ...
              className={`w-full mt-12 py-2 text-[12px] font-black transition-all uppercase tracking-[0.3em] ${
                isDark ? 'text-white/20 hover:text-white/60' : 'text-slate-300 hover:text-slate-500'
              }`}
            >
              Maybe Later
            </button>
