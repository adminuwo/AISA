      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <p className="text-white/50 text-sm mb-1 capitalize font-semibold">{toolName}</p>
            <p className="text-white/40 text-sm mb-6 leading-relaxed">
              {customMessage ? (
                ...
                <>
                  ...
                  <span className="text-amber-400 font-bold">paid plan users</span>. Upgrade your
                  plan to unlock all AI magic tools.
                </>
              )}
            </p>
