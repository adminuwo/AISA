          ...
          <div key={category.id} className="flex flex-col">
            ...
            >
              <div className="flex items-center gap-2">
                <Icon
                  className={`w-3.5 h-3.5 transition-colors ${isExpanded ? 'text-primary' : ''}`}
                />
                <span
                  className={`text-[12px] font-black uppercase tracking-[0.2em] transition-colors ${isExpanded ? 'text-primary' : ''}`}
                >
                  {category.title}
                </span>
              </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <span
                            className={`text-[13px] font-bold truncate ${isActive ? 'text-primary' : ''}`}
                          >
                            {tool.label}
                          </span>
                        </div>
                        {tool.premium && (
                          <Star
                            className={`w-2.5 h-2.5 fill-violet-500 text-violet-500 opacity-60`}
                          />
                        )}
                      </button>
                    );
