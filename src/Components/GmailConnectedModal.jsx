            ...
            <div className="p-6 sm:p-8">
                ...
                {features.map((feature, i) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div
                        className={`w-8 h-8 rounded-xl ${feature.iconBg} flex items-center justify-center shrink-0 mt-0.5`}
                      >
                        <feature.icon className={`w-4 h-4 ${feature.iconColor}`} />
                      </div>
                      <div className="flex-1 min-w-0">
                        <h4 className="font-bold text-sm text-gray-800 dark:text-white mb-0.5">
                          {feature.title}
                        </h4>
                        ...
                        <p
                          className={`text-[10px] font-bold mt-1.5 ${feature.iconColor} opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1`}
                        >
                          <Zap size={9} /> Try: {feature.example}
                        </p>
                      </div>
                      <ChevronRight
                        className={`w-4 h-4 ${feature.iconColor} opacity-0 group-hover:opacity-100 transition-opacity shrink-0 mt-1`}
                      />
                    </div>
                  </motion.div>
                ))}
              ...
              <div className="p-4 rounded-2xl bg-primary/5 border border-primary/15 mb-5">
                <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
                  <span className="font-black text-primary">💡 Pro Tip:</span> Click any feature
                  card above to instantly try it in the AISA™ chat, or just type naturally — AISA™
