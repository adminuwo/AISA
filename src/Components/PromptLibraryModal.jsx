...
const GENERATE_DATA = {
  ...
  'Social Media': {
    ...
    subjects: [
      ...
      'Luxury Travel Gear',
      'Sunset Beach Picnic',
      'Minimalist Desk Workspace',
      'Himalayan Hotel View',
    ],
  },
  'Product / Branding': {
    styles: [
...
const EDIT_DATA = {
  'Background Change': {
    ...
    actions: [
      'Remove the background and replace with',
      'Swap the current background for',
      'Change the scene behind the subject to',
      'Set the backdrop as a',
    ],
  },
  'Object Removal': {
    styles: ['clean plate', 'flawless repair', 'natural fill', 'seamless removal'],
    actions: [
      'Remove the unwanted objects from',
      'Clean up the background and remove people from',
      'Delete the distracting elements in',
      'Erase the foreground objects and fill with',
    ],
  },
  Lighting: {
    styles: [
    ...
    actions: [
      'Enhance the lighting for a',
      'Add a dramatic lighting effect like',
      'Change the entire mood to',
      'Relight the scene with',
    ],
  },
  Style: {
    styles: [
    ...
    actions: [
      'Transform this image into a',
      'Apply a professional style like',
      'Convert the look to',
      'Redraw the image in the style of',
    ],
  },
  Face: {
    styles: [
    ...
    actions: [
      'Improve facial details and add',
      'Retouch the face for',
      'Enhance features and apply',
      'Make the face look more like',
    ],
  },
  'Color Grading': {
    styles: [
    ...
    actions: [
      'Apply professional color grading for',
      'Modify the color palette to',
      'Enhance the saturation and add',
      'Apply a high-end film look like',
    ],
  },
};
...
const VIDEO_DATA = {
  Cinematic: {
    styles: [
      'Epic Slow Motion',
      'Aerial 4K Drone View',
      'Dramatic Low Angle',
      'Handheld Action Motion',
      'Cinematic Pan Right',
      'Steady Cam Chase',
    ],
    subjects: [
      'Warrior standing on cliff',
      'Steam train through forest',
      'Samurai duel in rain',
      'Falcon diving from sky',
      'Ship sailing through storm',
  ...
  'Social Media': {
    ...
    subjects: [
      ...
      'Street food cooking',
      'Skater doing tricks',
      'Model walking in city',
      'Sneaker unboxing',
      'Nature hiking montage',
    ],
  },
  Product: {
    styles: [
      'Macro Product Rotation',
      'Floating Studio Lighting',
      'High Speed Splash',
      'Exploded View Animation',
      'Sleek Minimal Pan',
      'Glitch Tech Showcase',
    ],
    subjects: [
      'Smartphone with glowing screen',
      'Luxury watch gears',
      'Diamond ring shimmering',
      'Perfume bottle with mist',
  ...
  Nature: {
    styles: [
      'National Geographic Vibe',
      'Vibrant 8K Nature',
      'Time-lapse Flower Bloom',
      'Macro Insect Motion',
      'Wide Landscape Reveal',
      'Undersea World Exploration',
    ],
    subjects: [
      'Waterfall in jungle',
      'Aurora Borealis over ice',
      'Lion chasing prey',
      'Volcanic ash rising',
  ...
  'Sci-fi / Fantasy': {
    styles: [
      'Interstellar Warp Effect',
      'Cyberpunk Neon Glow',
      'Magic Portal Opening',
      'Holographic Interface',
      'Epic Space Battle',
      'Magical Creature Flight',
    ],
    subjects: [
      'Spaceship docking at station',
      'Dragon breathing blue fire',
      'Futuristic Tokyo at night',
      'Hidden wizard tower',
      'Alien landscape with two suns',
      'Teleportation beam down',
    ],
  },
  Marketing: {
    styles: [
      'Corporate Professional Panning',
      'High Energy Transitions',
      'Bold Graphics Overlay',
      'Clean Product Reveal',
      'Dynamic Text-focused Motion',
    ],
    subjects: [
      'Team working in modern office',
      'Factory robotic precision',
      'Handshaking business deal',
...
const I2V_DATA = {
  'Cinematic Motion': {
    ...
    actions: [
      'Add slow cinematic zoom-in with',
      'Animate the scene with',
      'Create a moving cinematic shot using',
      'Enhance with a soft',
    ],
  },
  'Camera Movement': {
    ...
    actions: [
      'Apply smooth left-to-right camera pan with',
      'Create a drone-style upward camera movement with',
      'Add a sweeping orbital camera shot with',
      'Animate with a professional',
    ],
  },
  Environment: {
    styles: ['Realistic Rain', 'Natural Wind motion', 'Floating Fog', 'Magical Glowing Particles'],
    actions: [
      'Add realistic environmental effects like',
      'Enhance the atmosphere with',
      'Animate the background using',
      'Apply natural looking',
    ],
  },
  Character: {
    styles: [
      'Natural Body Motion',
      'Hair and Cloth Swaying',
      'Energetic Action',
      'Facial Retouching',
    ],
    actions: [
      'Animate the character with',
      'Add realistic movement to',
      'Create dynamic life-like motion in',
      'Enhance the subject with',
    ],
  },
  Loop: {
    styles: ['Seamless Loop', 'Continuous Motion', 'Infinite Sway', 'Cyclic Animation'],
    actions: [
      'Create a seamless loop animation with',
      'Apply continuous repeating motion like',
      'Animate for an infinite loop with',
      'Enhance as a perfect',
    ],
  },
};
...
const PromptLibraryModal = ({ isOpen, onClose, onSelect, mode = 'generate', referenceImage }) => {
  ...
  const allPrompts = useMemo(() => {
    ...
    if (mode === 'generate') {
      result.push({
        ...
        prompt:
          'A cinematic portrait of a man standing in rain, dramatic lighting, 4K, ultra realistic',
        category: 'Realistic',
      });
      result.push({
        id: id++,
        ...
        prompt:
          'Aesthetic flat lay with coffee, laptop and sunlight, soft shadows, Instagram style',
      ...
      result.push({
        ...
        prompt: 'Remove the background and replace with a modern office environment',
        category: 'Background Change',
      });
      result.push({
        id: id++,
        title: 'Enhance Quality',
        prompt: 'Increase image sharpness, upscale to HD, improve facial details',
        category: 'Face',
      });
    } else if (mode === 'video') {
      result.push({
        id: id++,
        title: 'Cinematic Rain Scene',
        prompt:
          'A cinematic video of a man walking alone in heavy rain at night, neon lights reflecting on wet streets, slow motion, dramatic lighting, 4K',
        category: 'Cinematic',
      });
      result.push({
        id: id++,
        title: 'Instagram Reel Aesthetic',
        prompt:
          'Aesthetic lifestyle reel with coffee, books and sunlight, soft transitions, smooth camera motion, warm tones',
        category: 'Social Media',
      });
      result.push({
        id: id++,
        ...
        prompt:
          'Professional product video of a smartphone rotating with glowing lights, clean background, smooth transitions, studio lighting',
        category: 'Product',
      });
      result.push({
        id: id++,
        title: 'Travel Vlog',
        prompt:
          'A travel video showing mountains, waterfalls and drone shots, bright daylight, smooth cinematic transitions',
        category: 'Travel',
      });
    } else if (mode === 'i2v') {
      result.push({
        ...
        prompt:
          'Add slow cinematic zoom-in with soft depth of field, gentle lighting changes, and subtle motion',
      ...
      result.push({
        ...
        title: 'Wind Effect',
        prompt:
          'Add natural wind motion, hair and clothes slightly moving, realistic environmental animation',
        category: 'Environment',
      });
      result.push({
        id: id++,
        title: 'Camera Pan',
        prompt: 'Apply smooth left-to-right camera pan with cinematic motion blur and depth',
        category: 'Camera Movement',
      });
      result.push({
        id: id++,
        title: 'Rain Effect',
        prompt: 'Add realistic rain with water drops, reflections, and dramatic lighting',
        category: 'Environment',
      });
      result.push({
        id: id++,
        title: 'Drone Shot',
        prompt:
          'Create a drone-style upward camera movement revealing surroundings with cinematic feel',
        category: 'Camera Movement',
      });
      result.push({
        id: id++,
        ...
        prompt:
          'Add 3D parallax motion separating foreground and background with smooth depth animation',
        category: 'Cinematic Motion',
      });
      result.push({
        id: id++,
        title: 'Cinematic Lighting',
        prompt: 'Animate lighting changes with soft glow, shadows, and dramatic highlights',
        category: 'Cinematic Motion',
      });
      result.push({
        id: id++,
        title: 'Loop Animation',
        prompt: 'Create a seamless loop animation with subtle continuous motion',
        category: 'Loop',
      });
      result.push({
        id: id++,
        title: 'Fantasy Glow',
        prompt: 'Add magical glowing particles, floating lights, and fantasy atmosphere',
        category: 'Fantasy',
      });
      result.push({
        id: id++,
        title: 'Action Movement',
        prompt: 'Add dynamic motion with fast camera movement and energetic scene transitions',
        category: 'Cinematic Motion',
      });
    }
    ...
    if (mode === 'edit' && referenceImage) {
      data['Smart Edit'] = {
        ...
        actions: [
          'Analyze and improve this image with',
          'Refine the textures and add',
          'Stylize the existing scene for better',
          'Polish the current frame using',
        ],
      };
    }
    ...
    Object.keys(data).forEach(cat => {
      ...
      for (let i = 0; i < 150; i++) {
        const style =
          catData.styles?.[Math.floor(Math.random() * catData.styles.length)] || 'Professional';

        if (mode === 'edit' || mode === 'i2v') {
          const action =
            catData.actions?.[Math.floor(Math.random() * catData.actions.length)] || 'Animate';
          result.push({
            id: id++,
            title: `${cat} - ${style}`,
            prompt: `${action} ${style} style, ensure high quality and professional output.`,
            category: cat,
          });
        } else if (mode === 'video') {
          const subject =
            catData.subjects?.[Math.floor(Math.random() * catData.subjects.length)] || 'Scene';
          result.push({
            id: id++,
            title: `${style} ${cat}`,
            prompt: `${style} of ${subject}, cinematic camera, professional color grading, high bitrate, 4K resolution.`,
            category: cat,
          });
        } else {
          const subject =
            catData.subjects?.[Math.floor(Math.random() * catData.subjects.length)] || 'Subject';
          result.push({
            id: id++,
            title: `${style} ${subject}`,
            prompt: `${style} of ${subject}, cinematic lighting, masterpiece, 8k, professional.`,
            category: cat,
          });
        }
      }
  ...
  const filteredPrompts = useMemo(() => {
    ...
    return allPrompts.filter(p => {
      if (activeCategory === 'Trending')
        return recent.includes(p.id) || favorites.slice(0, 5).includes(p.id) || p.id % 40 === 0;
      const matchesSearch =
  ...
  return createPortal(
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-2 sm:p-4 bg-slate-950/70 dark:bg-black/80 backdrop-blur-md overflow-y-auto modal-open-indicator">
          <motion.div
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] sm:text-[11px] font-bold text-slate-500 uppercase tracking-[0.2em] opacity-70">
                      {mode === 'video'
                        ? 'High-end Cinematic Video Synthesis'
                        : mode === 'edit'
                          ? 'Smart Suggestions for Image Modification'
                          : 'Procedurally Generated AI Masterpieces'}
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="relative group">
                  ...
                  <input
                    ...
                    placeholder={
                      mode === 'video'
                        ? 'Search cinematic shots, action scenes, or reels...'
                        : mode === 'edit'
                          ? 'Search for edit styles, filters, or effects...'
                          : 'Search styles, subjects, or keywords...'
                    }
                    value={searchQuery}
              ...
              {filteredPrompts.slice(0, page * itemsPerPage).length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                  {filteredPrompts.slice(0, page * itemsPerPage).map((p, idx) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          {recent.includes(p.id) && (
                            <span className="px-2.5 py-1 bg-green-500/10 text-green-600 text-[8px] font-black uppercase tracking-widest rounded-lg">
                              Recently Used
                            </span>
                          )}
                        </div>
                      ...
                      <h4 className="font-extrabold text-slate-800 text-[15px] mb-2 leading-tight group-hover:text-primary transition-colors">
                        {p.title}
                      </h4>
                ...
                <div className="flex flex-col items-center justify-center h-full py-20 opacity-30 text-center">
                  ...
                  <p className="text-xs font-bold text-slate-500 mt-1">
                    Try broadening your search or choosing "All"
                  </p>
                </div>
              )}
